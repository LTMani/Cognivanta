/**
 * ============================================================================
 * COGNIVANTA UPSTREAM PROVIDER: DEEPSEEKPROVIDERCLIENT
 * ============================================================================
 * Provider: deepseek
...
export class DeepSeekProviderClient implements LLMProviderClient {
  public readonly provider: LLMProvider = 'deepseek' as LLMProvider;
...
export const deepSeekProviderClient = new DeepSeekProviderClient();
