/**
 * ============================================================================
 * COGNIVANTA UPSTREAM PROVIDER: VERTEXAIPROVIDERCLIENT
 * ============================================================================
 * Provider: vertexai
...
export class VertexAIProviderClient implements LLMProviderClient {
  public readonly provider: LLMProvider = 'vertexai' as LLMProvider;
  private apiKey: string;
  private baseUrl: string;

  constructor(apiKey?: string, baseUrl?: string) {
    this.apiKey = apiKey || 'mock-key';
    this.baseUrl = baseUrl || 'https://api.vertexai.com/v1';
  }
...
export const vertexAIProviderClient = new VertexAIProviderClient();
