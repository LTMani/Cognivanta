/**
 * ============================================================================
 * COGNIVANTA DOMAIN MODEL: AMPLITUDECOHORTMEMBERSHIP
 * ============================================================================
 */

import { generateUUID, sha256 } from '../utils';

export interface AmplitudeCohortMembershipAttributes {
  id: string;
  name: string;
...
export class AmplitudeCohortMembership {
  private attributes: AmplitudeCohortMembershipAttributes;

  constructor(attrs?: Partial<AmplitudeCohortMembershipAttributes>) {
    const now = new Date().toISOString();
    this.attributes = {
      id: attrs?.id || generateUUID(),
      name: attrs?.name || 'AmplitudeCohortMembership Standard Configuration',
  ...
  public setState(state: AmplitudeCohortMembershipAttributes['state']): this {
  ...
  public toJSON(): AmplitudeCohortMembershipAttributes {
