/**
 * ============================================================================
 * COGNIVANTA DOMAIN MODEL: TOKENUSAGEBUDGET
 * ============================================================================
 * Description: Monthly token usage budget with alert thresholds
...
export interface TokenUsageBudgetAttributes {
  id: string;
  name: string;
...
export class TokenUsageBudget {
  private attributes: TokenUsageBudgetAttributes;

  constructor(attributes?: Partial<TokenUsageBudgetAttributes>) {
    const now = new Date().toISOString();
    this.attributes = {
      id: attributes?.id || generateUUID(),
      name: attributes?.name || 'TokenUsageBudget Instance',
  ...
  public update(attributes: Partial<TokenUsageBudgetAttributes>): this {
    this.attributes = {
      ...this.attributes,
      ...attributes,
  ...
  public setStatus(status: TokenUsageBudgetAttributes['status']): this {
  ...
  public toJSON(): TokenUsageBudgetAttributes {
    return { ...this.attributes };
  }

  public static fromJSON(json: Partial<TokenUsageBudgetAttributes>): TokenUsageBudget {
    return new TokenUsageBudget(json);
  }
