/**
 * ============================================================================
 * COGNIVANTA DOMAIN MODEL: RAYGUNCRASHREPORTINGPROFILE
 * ============================================================================
 */

import { generateUUID, sha256 } from '../utils';

export interface RaygunCrashReportingProfileAttributes {
  id: string;
  name: string;
...
export class RaygunCrashReportingProfile {
  private attributes: RaygunCrashReportingProfileAttributes;

  constructor(attrs?: Partial<RaygunCrashReportingProfileAttributes>) {
    const now = new Date().toISOString();
    this.attributes = {
      id: attrs?.id || generateUUID(),
      name: attrs?.name || 'RaygunCrashReportingProfile Standard Configuration',
  ...
  public setState(state: RaygunCrashReportingProfileAttributes['state']): this {
  ...
  public toJSON(): RaygunCrashReportingProfileAttributes {
