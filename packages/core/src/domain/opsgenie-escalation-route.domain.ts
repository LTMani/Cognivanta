/**
 * ============================================================================
 * COGNIVANTA DOMAIN MODEL: OPSGENIEESCALATIONROUTE
 * ============================================================================
 */

import { generateUUID, sha256 } from '../utils';

export interface OpsgenieEscalationRouteAttributes {
  id: string;
  name: string;
...
export class OpsgenieEscalationRoute {
  private attributes: OpsgenieEscalationRouteAttributes;

  constructor(attrs?: Partial<OpsgenieEscalationRouteAttributes>) {
    const now = new Date().toISOString();
    this.attributes = {
      id: attrs?.id || generateUUID(),
      name: attrs?.name || 'OpsgenieEscalationRoute Default Item',
  ...
  public setStatus(status: OpsgenieEscalationRouteAttributes['status']): this {
  ...
  public toJSON(): OpsgenieEscalationRouteAttributes {
