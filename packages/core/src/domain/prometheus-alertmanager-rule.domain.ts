/**
 * ============================================================================
 * COGNIVANTA DOMAIN MODEL: PROMETHEUSALERTMANAGERRULE
 * ============================================================================
 */

import { generateUUID, sha256 } from '../utils';

export interface PrometheusAlertmanagerRuleAttributes {
  id: string;
  name: string;
...
export class PrometheusAlertmanagerRule {
  private attributes: PrometheusAlertmanagerRuleAttributes;

  constructor(attrs?: Partial<PrometheusAlertmanagerRuleAttributes>) {
    const now = new Date().toISOString();
    this.attributes = {
      id: attrs?.id || generateUUID(),
      name: attrs?.name || 'PrometheusAlertmanagerRule Standard Configuration',
  ...
  public setState(state: PrometheusAlertmanagerRuleAttributes['state']): this {
  ...
  public toJSON(): PrometheusAlertmanagerRuleAttributes {
