/**
 * ============================================================================
 * COGNIVANTA DOMAIN MODEL: FINETUNEDLORAADAPTERWEIGHTS
 * ============================================================================
 */

import { generateUUID, sha256 } from '../utils';

export interface FineTunedLoraAdapterWeightsAttributes {
  id: string;
  name: string;
...
export class FineTunedLoraAdapterWeights {
  private attributes: FineTunedLoraAdapterWeightsAttributes;

  constructor(attrs?: Partial<FineTunedLoraAdapterWeightsAttributes>) {
    const now = new Date().toISOString();
    this.attributes = {
      id: attrs?.id || generateUUID(),
      name: attrs?.name || 'FineTunedLoraAdapterWeights Default Item',
  ...
  public setStatus(status: FineTunedLoraAdapterWeightsAttributes['status']): this {
  ...
  public toJSON(): FineTunedLoraAdapterWeightsAttributes {
