/**
 * ============================================================================
 * COGNIVANTA DOMAIN MODEL: NOTIFICATIONALERT
 * ============================================================================
 * Description: In-app and email notification alert with priority levels
...
export interface NotificationAlertAttributes {
  id: string;
  name: string;
...
export class NotificationAlert {
  private attributes: NotificationAlertAttributes;

  constructor(attributes?: Partial<NotificationAlertAttributes>) {
    const now = new Date().toISOString();
    this.attributes = {
      id: attributes?.id || generateUUID(),
      name: attributes?.name || 'NotificationAlert Instance',
  ...
  public update(attributes: Partial<NotificationAlertAttributes>): this {
    this.attributes = {
      ...this.attributes,
      ...attributes,
  ...
  public setStatus(status: NotificationAlertAttributes['status']): this {
  ...
  public toJSON(): NotificationAlertAttributes {
    return { ...this.attributes };
  }

  public static fromJSON(json: Partial<NotificationAlertAttributes>): NotificationAlert {
    return new NotificationAlert(json);
  }
