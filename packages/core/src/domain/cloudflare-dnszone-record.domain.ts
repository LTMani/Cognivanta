/**
 * ============================================================================
 * COGNIVANTA DOMAIN MODEL: CLOUDFLAREDNSZONERECORD
 * ============================================================================
 */

import { generateUUID, sha256 } from '../utils';

export interface CloudflareDNSZoneRecordAttributes {
  id: string;
  name: string;
...
export class CloudflareDNSZoneRecord {
  private attributes: CloudflareDNSZoneRecordAttributes;

  constructor(attrs?: Partial<CloudflareDNSZoneRecordAttributes>) {
    const now = new Date().toISOString();
    this.attributes = {
      id: attrs?.id || generateUUID(),
      name: attrs?.name || 'CloudflareDNSZoneRecord Standard Configuration',
  ...
  public setState(state: CloudflareDNSZoneRecordAttributes['state']): this {
  ...
  public toJSON(): CloudflareDNSZoneRecordAttributes {
