/**
 * ============================================================================
 * COGNIVANTA DOMAIN MODEL: FRESHDESKSUPPORTAGENTPROFILE
 * ============================================================================
 */

import { generateUUID, sha256 } from '../utils';

export interface FreshdeskSupportAgentProfileAttributes {
  id: string;
  name: string;
...
export class FreshdeskSupportAgentProfile {
  private attributes: FreshdeskSupportAgentProfileAttributes;

  constructor(attrs?: Partial<FreshdeskSupportAgentProfileAttributes>) {
    const now = new Date().toISOString();
    this.attributes = {
      id: attrs?.id || generateUUID(),
      name: attrs?.name || 'FreshdeskSupportAgentProfile Standard Configuration',
  ...
  public setState(state: FreshdeskSupportAgentProfileAttributes['state']): this {
  ...
  public toJSON(): FreshdeskSupportAgentProfileAttributes {
