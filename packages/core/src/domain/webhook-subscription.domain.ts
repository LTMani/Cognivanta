 ...
 * ============================================================================
 * Description: Incoming / outgoing webhook subscription with HMAC secret
...
export class WebhookSubscription {
  private attributes: WebhookSubscriptionAttributes;

  constructor(attributes?: Partial<WebhookSubscriptionAttributes>) {
    const now = new Date().toISOString();
    this.attributes = {
      id: attributes?.id || generateUUID(),
      name: attributes?.name || 'WebhookSubscription Instance',
  ...
  public update(attributes: Partial<WebhookSubscriptionAttributes>): this {
    this.attributes = {
      ...this.attributes,
      ...attributes,
  ...
  public setStatus(status: WebhookSubscriptionAttributes['status']): this {
  ...
  public static fromJSON(json: Partial<WebhookSubscriptionAttributes>): WebhookSubscription {
    return new WebhookSubscription(json);
  }
