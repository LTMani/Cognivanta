/**
 * ============================================================================
 * COGNIVANTA DOMAIN MODEL: POSTMARKOUTBOUNDMESSAGE
 * ============================================================================
 */

import { generateUUID, sha256 } from '../utils';

export interface PostmarkOutboundMessageAttributes {
  id: string;
  name: string;
...
export class PostmarkOutboundMessage {
  private attributes: PostmarkOutboundMessageAttributes;

  constructor(attrs?: Partial<PostmarkOutboundMessageAttributes>) {
    const now = new Date().toISOString();
    this.attributes = {
      id: attrs?.id || generateUUID(),
      name: attrs?.name || 'PostmarkOutboundMessage Standard Configuration',
  ...
  public setState(state: PostmarkOutboundMessageAttributes['state']): this {
  ...
  public toJSON(): PostmarkOutboundMessageAttributes {
