/**
 * ============================================================================
 * COGNIVANTA DOMAIN MODEL: AKAMAIEDGEWORKERCONFIG
 * ============================================================================
 */

import { generateUUID, sha256 } from '../utils';

export interface AkamaiEdgeWorkerConfigAttributes {
  id: string;
  name: string;
...
export class AkamaiEdgeWorkerConfig {
  private attributes: AkamaiEdgeWorkerConfigAttributes;

  constructor(attrs?: Partial<AkamaiEdgeWorkerConfigAttributes>) {
    const now = new Date().toISOString();
    this.attributes = {
      id: attrs?.id || generateUUID(),
      name: attrs?.name || 'AkamaiEdgeWorkerConfig Standard Configuration',
  ...
  public setState(state: AkamaiEdgeWorkerConfigAttributes['state']): this {
  ...
  public toJSON(): AkamaiEdgeWorkerConfigAttributes {
