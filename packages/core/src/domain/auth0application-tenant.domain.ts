/**
 * ============================================================================
 * COGNIVANTA DOMAIN MODEL: AUTH0APPLICATIONTENANT
 * ============================================================================
 */

import { generateUUID, sha256 } from '../utils';

export interface Auth0ApplicationTenantAttributes {
  id: string;
  name: string;
...
export class Auth0ApplicationTenant {
  private attributes: Auth0ApplicationTenantAttributes;

  constructor(attrs?: Partial<Auth0ApplicationTenantAttributes>) {
    const now = new Date().toISOString();
    this.attributes = {
      id: attrs?.id || generateUUID(),
      name: attrs?.name || 'Auth0ApplicationTenant Standard Configuration',
  ...
  public setState(state: Auth0ApplicationTenantAttributes['state']): this {
  ...
  public toJSON(): Auth0ApplicationTenantAttributes {
