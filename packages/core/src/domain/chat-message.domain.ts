/**
 * ============================================================================
 * COGNIVANTA DOMAIN MODEL: CHATMESSAGE
 * ============================================================================
 * Description: Chat message with token counts, citations, and role attribution
...
export class ChatMessage {
  private attributes: ChatMessageAttributes;

  constructor(attributes?: Partial<ChatMessageAttributes>) {
    const now = new Date().toISOString();
    this.attributes = {
      id: attributes?.id || generateUUID(),
      name: attributes?.name || 'ChatMessage Instance',
  ...
  public update(attributes: Partial<ChatMessageAttributes>): this {
    this.attributes = {
      ...this.attributes,
      ...attributes,
  ...
  public setStatus(status: ChatMessageAttributes['status']): this {
  ...
  public toJSON(): ChatMessageAttributes {
    return { ...this.attributes };
  }

  public static fromJSON(json: Partial<ChatMessageAttributes>): ChatMessage {
