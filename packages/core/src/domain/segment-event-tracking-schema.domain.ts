/**
 * ============================================================================
 * COGNIVANTA DOMAIN MODEL: SEGMENTEVENTTRACKINGSCHEMA
 * ============================================================================
 */

import { generateUUID, sha256 } from '../utils';

export interface SegmentEventTrackingSchemaAttributes {
  id: string;
  name: string;
...
export class SegmentEventTrackingSchema {
  private attributes: SegmentEventTrackingSchemaAttributes;

  constructor(attrs?: Partial<SegmentEventTrackingSchemaAttributes>) {
    const now = new Date().toISOString();
    this.attributes = {
      id: attrs?.id || generateUUID(),
      name: attrs?.name || 'SegmentEventTrackingSchema Standard Configuration',
  ...
  public setState(state: SegmentEventTrackingSchemaAttributes['state']): this {
  ...
  public toJSON(): SegmentEventTrackingSchemaAttributes {
