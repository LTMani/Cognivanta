/**
 * ============================================================================
 * COGNIVANTA DOMAIN MODEL: CONNECTORSYNCJOB
 * ============================================================================
 * Description: Connector delta sync job with processed document counts
...
export interface ConnectorSyncJobAttributes {
  id: string;
  name: string;
...
export class ConnectorSyncJob {
  private attributes: ConnectorSyncJobAttributes;

  constructor(attributes?: Partial<ConnectorSyncJobAttributes>) {
    const now = new Date().toISOString();
    this.attributes = {
      id: attributes?.id || generateUUID(),
      name: attributes?.name || 'ConnectorSyncJob Instance',
  ...
  public update(attributes: Partial<ConnectorSyncJobAttributes>): this {
    this.attributes = {
      ...this.attributes,
      ...attributes,
  ...
  public setStatus(status: ConnectorSyncJobAttributes['status']): this {
  ...
  public toJSON(): ConnectorSyncJobAttributes {
    return { ...this.attributes };
  }

  public static fromJSON(json: Partial<ConnectorSyncJobAttributes>): ConnectorSyncJob {
    return new ConnectorSyncJob(json);
  }
