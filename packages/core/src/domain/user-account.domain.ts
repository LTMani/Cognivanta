/**
 * ============================================================================
 * COGNIVANTA DOMAIN MODEL: USERACCOUNT
 * ============================================================================
 * Description: Enterprise user account with RBAC roles, MFA, and preferences
...
export class UserAccount {
  private attributes: UserAccountAttributes;

  constructor(attributes?: Partial<UserAccountAttributes>) {
    const now = new Date().toISOString();
    this.attributes = {
      id: attributes?.id || generateUUID(),
      name: attributes?.name || 'UserAccount Instance',
  ...
  public update(attributes: Partial<UserAccountAttributes>): this {
    this.attributes = {
      ...this.attributes,
      ...attributes,
  ...
  public setStatus(status: UserAccountAttributes['status']): this {
  ...
  public toJSON(): UserAccountAttributes {
    return { ...this.attributes };
  }

  public static fromJSON(json: Partial<UserAccountAttributes>): UserAccount {
    return new UserAccount(json);
  }
