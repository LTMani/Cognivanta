/**
 * ============================================================================
 * COGNIVANTA DOMAIN MODEL: TWILIOVOICECALLRECORD
 * ============================================================================
 */

import { generateUUID, sha256 } from '../utils';

export interface TwilioVoiceCallRecordAttributes {
  id: string;
  name: string;
...
export class TwilioVoiceCallRecord {
  private attributes: TwilioVoiceCallRecordAttributes;

  constructor(attrs?: Partial<TwilioVoiceCallRecordAttributes>) {
    const now = new Date().toISOString();
    this.attributes = {
      id: attrs?.id || generateUUID(),
      name: attrs?.name || 'TwilioVoiceCallRecord Standard Configuration',
  ...
  public setState(state: TwilioVoiceCallRecordAttributes['state']): this {
  ...
  public toJSON(): TwilioVoiceCallRecordAttributes {
