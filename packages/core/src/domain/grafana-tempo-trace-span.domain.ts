/**
 * ============================================================================
 * COGNIVANTA DOMAIN MODEL: GRAFANATEMPOTRACESPAN
 * ============================================================================
 */

import { generateUUID, sha256 } from '../utils';

export interface GrafanaTempoTraceSpanAttributes {
  id: string;
  name: string;
...
export class GrafanaTempoTraceSpan {
  private attributes: GrafanaTempoTraceSpanAttributes;

  constructor(attrs?: Partial<GrafanaTempoTraceSpanAttributes>) {
    const now = new Date().toISOString();
    this.attributes = {
      id: attrs?.id || generateUUID(),
      name: attrs?.name || 'GrafanaTempoTraceSpan Standard Configuration',
  ...
  public setState(state: GrafanaTempoTraceSpanAttributes['state']): this {
  ...
  public toJSON(): GrafanaTempoTraceSpanAttributes {
