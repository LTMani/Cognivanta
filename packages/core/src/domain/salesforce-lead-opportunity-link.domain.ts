/**
 * ============================================================================
 * COGNIVANTA DOMAIN MODEL: SALESFORCELEADOPPORTUNITYLINK
 * ============================================================================
 */

import { generateUUID, sha256 } from '../utils';

export interface SalesforceLeadOpportunityLinkAttributes {
  id: string;
  name: string;
...
export class SalesforceLeadOpportunityLink {
  private attributes: SalesforceLeadOpportunityLinkAttributes;

  constructor(attrs?: Partial<SalesforceLeadOpportunityLinkAttributes>) {
    const now = new Date().toISOString();
    this.attributes = {
      id: attrs?.id || generateUUID(),
      name: attrs?.name || 'SalesforceLeadOpportunityLink Standard Configuration',
  ...
  public setState(state: SalesforceLeadOpportunityLinkAttributes['state']): this {
  ...
  public toJSON(): SalesforceLeadOpportunityLinkAttributes {
