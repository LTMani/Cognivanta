/**
 * ============================================================================
 * COGNIVANTA DOMAIN MODEL: SENTRYISSUEGROUPINGRULE
 * ============================================================================
 */

import { generateUUID, sha256 } from '../utils';

export interface SentryIssueGroupingRuleAttributes {
  id: string;
  name: string;
...
export class SentryIssueGroupingRule {
  private attributes: SentryIssueGroupingRuleAttributes;

  constructor(attrs?: Partial<SentryIssueGroupingRuleAttributes>) {
    const now = new Date().toISOString();
    this.attributes = {
      id: attrs?.id || generateUUID(),
      name: attrs?.name || 'SentryIssueGroupingRule Standard Configuration',
  ...
  public setState(state: SentryIssueGroupingRuleAttributes['state']): this {
  ...
  public toJSON(): SentryIssueGroupingRuleAttributes {
