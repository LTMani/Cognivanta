/**
 * ============================================================================
 * COGNIVANTA DOMAIN MODEL: ZENDESKTICKETCUSTOMFIELD
 * ============================================================================
 */

import { generateUUID, sha256 } from '../utils';

export interface ZendeskTicketCustomFieldAttributes {
  id: string;
  name: string;
...
export class ZendeskTicketCustomField {
  private attributes: ZendeskTicketCustomFieldAttributes;

  constructor(attrs?: Partial<ZendeskTicketCustomFieldAttributes>) {
    const now = new Date().toISOString();
    this.attributes = {
      id: attrs?.id || generateUUID(),
      name: attrs?.name || 'ZendeskTicketCustomField Standard Configuration',
  ...
  public setState(state: ZendeskTicketCustomFieldAttributes['state']): this {
  ...
  public toJSON(): ZendeskTicketCustomFieldAttributes {
