/**
 * ============================================================================
 * COGNIVANTA DOMAIN MODEL: RERANKERMODELWEIGHTS
 * ============================================================================
 */

import { generateUUID, sha256 } from '../utils';

export interface RerankerModelWeightsAttributes {
  id: string;
  name: string;
...
export class RerankerModelWeights {
  private attributes: RerankerModelWeightsAttributes;

  constructor(attrs?: Partial<RerankerModelWeightsAttributes>) {
    const now = new Date().toISOString();
    this.attributes = {
      id: attrs?.id || generateUUID(),
      name: attrs?.name || 'RerankerModelWeights Default Item',
  ...
  public setStatus(status: RerankerModelWeightsAttributes['status']): this {
  ...
  public toJSON(): RerankerModelWeightsAttributes {
