/**
 * ============================================================================
 * COGNIVANTA DOMAIN MODEL: INVOICELINEITEM
 * ============================================================================
 */
...
export class InvoiceLineItem {
  private attributes: InvoiceLineItemAttributes;

  constructor(attrs?: Partial<InvoiceLineItemAttributes>) {
    const now = new Date().toISOString();
    this.attributes = {
      id: attrs?.id || generateUUID(),
      name: attrs?.name || 'InvoiceLineItem Default Item',
  ...
  public setStatus(status: InvoiceLineItemAttributes['status']): this {
  ...
  public toJSON(): InvoiceLineItemAttributes {
