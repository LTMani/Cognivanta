/**
 * ============================================================================
 * COGNIVANTA DOMAIN MODEL: MONGODBREPLICASETMEMBER
 * ============================================================================
 */

import { generateUUID, sha256 } from '../utils';

export interface MongoDBReplicaSetMemberAttributes {
  id: string;
  name: string;
...
export class MongoDBReplicaSetMember {
  private attributes: MongoDBReplicaSetMemberAttributes;

  constructor(attrs?: Partial<MongoDBReplicaSetMemberAttributes>) {
    const now = new Date().toISOString();
    this.attributes = {
      id: attrs?.id || generateUUID(),
      name: attrs?.name || 'MongoDBReplicaSetMember Standard Configuration',
  ...
  public setState(state: MongoDBReplicaSetMemberAttributes['state']): this {
  ...
  public toJSON(): MongoDBReplicaSetMemberAttributes {
