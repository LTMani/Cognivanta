/**
 * ============================================================================
 * COGNIVANTA DOMAIN MODEL: HUBSPOTCOMPANYCONTACTLINK
 * ============================================================================
 */

import { generateUUID, sha256 } from '../utils';

export interface HubspotCompanyContactLinkAttributes {
  id: string;
  name: string;
...
export class HubspotCompanyContactLink {
  private attributes: HubspotCompanyContactLinkAttributes;

  constructor(attrs?: Partial<HubspotCompanyContactLinkAttributes>) {
    const now = new Date().toISOString();
    this.attributes = {
      id: attrs?.id || generateUUID(),
      name: attrs?.name || 'HubspotCompanyContactLink Standard Configuration',
  ...
  public setState(state: HubspotCompanyContactLinkAttributes['state']): this {
  ...
  public toJSON(): HubspotCompanyContactLinkAttributes {
