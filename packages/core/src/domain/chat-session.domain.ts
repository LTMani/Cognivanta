/**
 * ============================================================================
 * COGNIVANTA DOMAIN MODEL: CHATSESSION
 * ============================================================================
 * Description: Multi-turn chat session with state history and model configs
...
export class ChatSession {
  private attributes: ChatSessionAttributes;

  constructor(attributes?: Partial<ChatSessionAttributes>) {
    const now = new Date().toISOString();
    this.attributes = {
      id: attributes?.id || generateUUID(),
      name: attributes?.name || 'ChatSession Instance',
  ...
  public update(attributes: Partial<ChatSessionAttributes>): this {
    this.attributes = {
      ...this.attributes,
      ...attributes,
  ...
  public setStatus(status: ChatSessionAttributes['status']): this {
  ...
  public toJSON(): ChatSessionAttributes {
    return { ...this.attributes };
  }

  public static fromJSON(json: Partial<ChatSessionAttributes>): ChatSession {
