/**
 * ============================================================================
 * COGNIVANTA DOMAIN MODEL: BRAINTREEMERCHANTACCOUNT
 * ============================================================================
 */

import { generateUUID, sha256 } from '../utils';

export interface BraintreeMerchantAccountAttributes {
  id: string;
  name: string;
...
export class BraintreeMerchantAccount {
  private attributes: BraintreeMerchantAccountAttributes;

  constructor(attrs?: Partial<BraintreeMerchantAccountAttributes>) {
    const now = new Date().toISOString();
    this.attributes = {
      id: attrs?.id || generateUUID(),
      name: attrs?.name || 'BraintreeMerchantAccount Standard Configuration',
  ...
  public setState(state: BraintreeMerchantAccountAttributes['state']): this {
  ...
  public toJSON(): BraintreeMerchantAccountAttributes {
