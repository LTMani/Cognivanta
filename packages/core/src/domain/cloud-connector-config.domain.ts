/**
 * ============================================================================
 * COGNIVANTA DOMAIN MODEL: CLOUDCONNECTORCONFIG
 * ============================================================================
 * Description: SaaS / Cloud storage connector configuration and sync schedule
...
export interface CloudConnectorConfigAttributes {
  id: string;
  name: string;
...
export class CloudConnectorConfig {
  private attributes: CloudConnectorConfigAttributes;

  constructor(attributes?: Partial<CloudConnectorConfigAttributes>) {
    const now = new Date().toISOString();
    this.attributes = {
      id: attributes?.id || generateUUID(),
      name: attributes?.name || 'CloudConnectorConfig Instance',
  ...
  public update(attributes: Partial<CloudConnectorConfigAttributes>): this {
    this.attributes = {
      ...this.attributes,
      ...attributes,
  ...
  public setStatus(status: CloudConnectorConfigAttributes['status']): this {
  ...
  public toJSON(): CloudConnectorConfigAttributes {
    return { ...this.attributes };
  }

  public static fromJSON(json: Partial<CloudConnectorConfigAttributes>): CloudConnectorConfig {
    return new CloudConnectorConfig(json);
  }
