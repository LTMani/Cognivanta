/**
 * ============================================================================
 * COGNIVANTA DOMAIN MODEL: COSTATTRIBUTIONREPORT
 * ============================================================================
 * Description: Cost attribution report broken down by team and model
...
export interface CostAttributionReportAttributes {
  id: string;
  name: string;
...
export class CostAttributionReport {
  private attributes: CostAttributionReportAttributes;

  constructor(attributes?: Partial<CostAttributionReportAttributes>) {
    const now = new Date().toISOString();
    this.attributes = {
      id: attributes?.id || generateUUID(),
      name: attributes?.name || 'CostAttributionReport Instance',
  ...
  public update(attributes: Partial<CostAttributionReportAttributes>): this {
    this.attributes = {
      ...this.attributes,
      ...attributes,
  ...
  public setStatus(status: CostAttributionReportAttributes['status']): this {
  ...
  public toJSON(): CostAttributionReportAttributes {
    return { ...this.attributes };
  }

  public static fromJSON(json: Partial<CostAttributionReportAttributes>): CostAttributionReport {
    return new CostAttributionReport(json);
  }
