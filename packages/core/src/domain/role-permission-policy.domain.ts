/**
 * ============================================================================
 * COGNIVANTA DOMAIN MODEL: ROLEPERMISSIONPOLICY
 * ============================================================================
 * Description: ABAC / RBAC role permission policy matrix
...
export interface RolePermissionPolicyAttributes {
  id: string;
  name: string;
...
export class RolePermissionPolicy {
  private attributes: RolePermissionPolicyAttributes;

  constructor(attributes?: Partial<RolePermissionPolicyAttributes>) {
    const now = new Date().toISOString();
    this.attributes = {
      id: attributes?.id || generateUUID(),
      name: attributes?.name || 'RolePermissionPolicy Instance',
  ...
  public update(attributes: Partial<RolePermissionPolicyAttributes>): this {
    this.attributes = {
      ...this.attributes,
      ...attributes,
  ...
  public setStatus(status: RolePermissionPolicyAttributes['status']): this {
  ...
  public toJSON(): RolePermissionPolicyAttributes {
    return { ...this.attributes };
  }

  public static fromJSON(json: Partial<RolePermissionPolicyAttributes>): RolePermissionPolicy {
    return new RolePermissionPolicy(json);
  }
