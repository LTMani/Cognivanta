/**
 * ============================================================================
 * COGNIVANTA AGENT PERSONA: CONTENTSTRATEGISTAGENT
 * ============================================================================
 * Role: Technical Communications Director
 * Description: Drafts technical whitepapers, architectural blueprints, and developer guides.
 */
...
export class ContentStrategistAgent {
  public readonly personaId = 'content-strategist';
  public readonly roleTitle = 'Technical Communications Director';
  public readonly defaultDescription = 'Drafts technical whitepapers, architectural blueprints, and developer guides.';
...
export const content_strategistPersona = new ContentStrategistAgent();
