/**
 * ============================================================================
 * COGNIVANTA AGENT PERSONA: LEGALCOUNSELAGENT
 * ============================================================================
 * Role: Corporate Legal Advisor
 * Description: Reviews commercial contracts, identifies liability clauses, and ensures GDPR compliance.
 */
...
export class LegalCounselAgent {
  public readonly personaId = 'legal-counsel';
  public readonly roleTitle = 'Corporate Legal Advisor';
  public readonly defaultDescription = 'Reviews commercial contracts, identifies liability clauses, and ensures GDPR compliance.';
...
export const legal_counselPersona = new LegalCounselAgent();
