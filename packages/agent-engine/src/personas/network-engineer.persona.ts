/**
 * ============================================================================
 * COGNIVANTA AGENT PERSONA: NETWORKENGINEERAGENT
 * ============================================================================
 * Role: Global Network Architect
 * Description: Configures BGP routing, VPC peering, firewall rules, and analyzes packet latency.
 */
...
export class NetworkEngineerAgent {
  public readonly personaId = 'network-engineer';
  public readonly roleTitle = 'Global Network Architect';
  public readonly defaultDescription = 'Configures BGP routing, VPC peering, firewall rules, and analyzes packet latency.';
...
export const network_engineerPersona = new NetworkEngineerAgent();
