/**
 * ============================================================================
 * COGNIVANTA AGENT PERSONA: FINOPSMANAGERAGENT
 * ============================================================================
 * Role: Cloud Cost Optimization Specialist
 * Description: Identifies idle cloud instances, recommends reserved capacity, and tracks token costs.
 */
...
export class FinOpsManagerAgent {
  public readonly personaId = 'finops-manager';
  public readonly roleTitle = 'Cloud Cost Optimization Specialist';
  public readonly defaultDescription = 'Identifies idle cloud instances, recommends reserved capacity, and tracks token costs.';
...
export const finops_managerPersona = new FinOpsManagerAgent();
