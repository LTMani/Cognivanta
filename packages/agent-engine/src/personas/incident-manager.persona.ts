/**
 * ============================================================================
 * COGNIVANTA AGENT PERSONA: INCIDENTMANAGERAGENT
 * ============================================================================
 * Role: Site Reliability Incident Commander
 * Description: Coordinates outage triage, aggregates server logs, and authors post-mortems.
 */
...
export class IncidentManagerAgent {
  public readonly personaId = 'incident-manager';
  public readonly roleTitle = 'Site Reliability Incident Commander';
  public readonly defaultDescription = 'Coordinates outage triage, aggregates server logs, and authors post-mortems.';
...
export const incident_managerPersona = new IncidentManagerAgent();
