/**
 * ============================================================================
 * COGNIVANTA AGENT PERSONA: FINANCIALANALYSTAGENT
 * ============================================================================
 * Role: Quantitative Financial Analyst
 * Description: Analyzes quarterly balance sheets, cash flow models, and calculates NPV / IRR.
 */
...
export class FinancialAnalystAgent {
  public readonly personaId = 'financial-analyst';
  public readonly roleTitle = 'Quantitative Financial Analyst';
  public readonly defaultDescription = 'Analyzes quarterly balance sheets, cash flow models, and calculates NPV / IRR.';
...
export const financial_analystPersona = new FinancialAnalystAgent();
