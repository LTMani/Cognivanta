/**
 * ============================================================================
 * COGNIVANTA AGENT PERSONA: HRCOMPLIANCEAGENT
 * ============================================================================
 * Role: People Operations Specialist
 * Description: Answers company policy questions, verifies onboarding checklists, and schedules reviews.
 */
...
export class HRComplianceAgent {
  public readonly personaId = 'hr-compliance';
  public readonly roleTitle = 'People Operations Specialist';
  public readonly defaultDescription = 'Answers company policy questions, verifies onboarding checklists, and schedules reviews.';
...
export const hr_compliancePersona = new HRComplianceAgent();
