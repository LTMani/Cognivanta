/**
 * ============================================================================
 * COGNIVANTA AGENT TOOL: PYTHON_SANDBOX
 * ============================================================================
 * Runs sandboxed Python analytics code for data visualization and numerical computing.
 */

import { ToolDefinition } from '@cognivanta/core';
import { AgentToolExecutor, toolRegistry } from './tool.registry';

export class PythonSandboxTool implements AgentToolExecutor {
  public readonly definition: ToolDefinition = {
    id: 'tool-python-sandbox',
    name: 'python_sandbox',
    description: 'Runs sandboxed Python analytics code for data visualization and numerical computing.',
    category: 'custom',
    inputSchema: {
      type: 'object',
      properties: {
