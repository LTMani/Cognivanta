/**
 * ============================================================================
 * COGNIVANTA AGENT TOOL: SLACK_DISPATCHER
 * ============================================================================
 * Sends formatted incident reports, KPI summaries, and automated alerts to enterprise Slack channels.
 */

import { ToolDefinition } from '@cognivanta/core';
import { AgentToolExecutor, toolRegistry } from './tool.registry';

export class SlackDispatcherTool implements AgentToolExecutor {
  public readonly definition: ToolDefinition = {
    id: 'tool-slack-dispatcher',
    name: 'slack_dispatcher',
    description: 'Sends formatted incident reports, KPI summaries, and automated alerts to enterprise Slack channels.',
    category: 'custom',
    inputSchema: {
      type: 'object',
      properties: {
...
toolRegistry.register(new SlackDispatcherTool());
