/**
 * ============================================================================
 * COGNIVANTA CLOUD CONNECTOR: BIGQUERYWAREHOUSECONNECTOR
 * ============================================================================
...
export interface BigQueryWarehouseConnectorConfig {
  connectionId: string;
...
export class BigQueryWarehouseConnector {
  public readonly connectorId = 'bigquery';
  public readonly category = 'warehouse';
  public readonly protocol = 'bigquery_v2';
  private config: BigQueryWarehouseConnectorConfig;

  constructor(config?: Partial<BigQueryWarehouseConnectorConfig>) {
    this.config = {
...
export const bigqueryConnector = new BigQueryWarehouseConnector();
