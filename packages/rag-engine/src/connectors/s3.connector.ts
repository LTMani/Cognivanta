/**
 * ============================================================================
 * COGNIVANTA CLOUD CONNECTOR: AMAZONS3CONNECTOR
 * ============================================================================
...
export interface AmazonS3ConnectorConfig {
  connectionId: string;
...
export class AmazonS3Connector {
  public readonly connectorId = 's3';
  public readonly category = 'storage';
  public readonly protocol = 'aws_s3_sdk';
  private config: AmazonS3ConnectorConfig;

  constructor(config?: Partial<AmazonS3ConnectorConfig>) {
    this.config = {
...
export const s3Connector = new AmazonS3Connector();
