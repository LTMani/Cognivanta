/**
 * ============================================================================
 * COGNIVANTA CLOUD CONNECTOR: MYSQLDATABASECONNECTOR
 * ============================================================================
...
export interface MySQLDatabaseConnectorConfig {
  connectionId: string;
...
export class MySQLDatabaseConnector {
  public readonly connectorId = 'mysql';
  public readonly category = 'database';
  public readonly protocol = 'mysql2_protocol';
  private config: MySQLDatabaseConnectorConfig;

  constructor(config?: Partial<MySQLDatabaseConnectorConfig>) {
    this.config = {
...
export const mysqlConnector = new MySQLDatabaseConnector();
