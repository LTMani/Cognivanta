/**
 * ============================================================================
 * COGNIVANTA CLOUD CONNECTOR: SNOWFLAKEDATAWAREHOUSECONNECTOR
 * ============================================================================
...
export interface SnowflakeDataWarehouseConnectorConfig {
  connectionId: string;
...
export class SnowflakeDataWarehouseConnector {
  public readonly connectorId = 'snowflake';
  public readonly category = 'warehouse';
  public readonly protocol = 'snowflake_rest';
  private config: SnowflakeDataWarehouseConnectorConfig;

  constructor(config?: Partial<SnowflakeDataWarehouseConnectorConfig>) {
    this.config = {
...
export const snowflakeConnector = new SnowflakeDataWarehouseConnector();
