/**
 * ============================================================================
 * COGNIVANTA CLOUD CONNECTOR: CONFLUENCEWIKICONNECTOR
 * ============================================================================
...
export interface ConfluenceWikiConnectorConfig {
  connectionId: string;
...
export class ConfluenceWikiConnector {
  public readonly connectorId = 'confluence';
  public readonly category = 'saas';
  public readonly protocol = 'atlassian_rest';
  private config: ConfluenceWikiConnectorConfig;

  constructor(config?: Partial<ConfluenceWikiConnectorConfig>) {
    this.config = {
...
export const confluenceConnector = new ConfluenceWikiConnector();
