/**
 * ============================================================================
 * COGNIVANTA DATA CONNECTOR: WEBCRAWLERCONNECTOR
 * ============================================================================
 * Integration: Web Sitemap & URL Crawler
 * Description: Crawls enterprise documentation websites, strips boilerplate HTML, and extracts clean markdown.
 */
...
export class WebCrawlerConnector {
