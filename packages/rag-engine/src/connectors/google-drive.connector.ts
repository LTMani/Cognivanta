/**
 * ============================================================================
 * COGNIVANTA CLOUD CONNECTOR: GOOGLEDRIVECONNECTOR
 * ============================================================================
...
export class GoogleDriveConnector {
  public readonly connectorId = 'google-drive';
  public readonly category = 'document';
  public readonly protocol = 'google_drive_v3';
  private config: GoogleDriveConnectorConfig;

  constructor(config?: Partial<GoogleDriveConnectorConfig>) {
    this.config = {
...
export const google_driveConnector = new GoogleDriveConnector();
