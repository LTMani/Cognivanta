...
export class ElasticsearchConnector {
  public readonly connectorId = 'elasticsearch';
  public readonly category = 'search';
  public readonly protocol = 'elasticsearch_rest';
  private config: ElasticsearchConnectorConfig;

  constructor(config?: Partial<ElasticsearchConnectorConfig>) {
    this.config = {
