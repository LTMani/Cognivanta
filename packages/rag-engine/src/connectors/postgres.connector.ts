/**
 * ============================================================================
 * COGNIVANTA DATA CONNECTOR: POSTGRESCONNECTOR
 * ============================================================================
 * Integration: PostgreSQL Relational DB
 * Description: Extracts relational tables, views, and schemas into structured RAG datasets.
 */
