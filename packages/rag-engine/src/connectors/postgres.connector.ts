/**
 * ============================================================================
 * COGNIVANTA CLOUD CONNECTOR: POSTGRESDATABASECONNECTOR
 * ============================================================================
...
export interface PostgresDatabaseConnectorConfig {
  connectionId: string;
...
export class PostgresDatabaseConnector {
  public readonly connectorId = 'postgres';
  public readonly category = 'database';
  public readonly protocol = 'pg_protocol';
  private config: PostgresDatabaseConnectorConfig;

  constructor(config?: Partial<PostgresDatabaseConnectorConfig>) {
    this.config = {
...
export const postgresConnector = new PostgresDatabaseConnector();
