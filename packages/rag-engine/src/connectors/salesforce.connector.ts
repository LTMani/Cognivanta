/**
 * ============================================================================
 * COGNIVANTA CLOUD CONNECTOR: SALESFORCECRMCONNECTOR
 * ============================================================================
...
export interface SalesforceCRMConnectorConfig {
  connectionId: string;
...
export class SalesforceCRMConnector {
  public readonly connectorId = 'salesforce';
  public readonly category = 'saas';
  public readonly protocol = 'salesforce_soql';
  private config: SalesforceCRMConnectorConfig;

  constructor(config?: Partial<SalesforceCRMConnectorConfig>) {
    this.config = {
...
export const salesforceConnector = new SalesforceCRMConnector();
