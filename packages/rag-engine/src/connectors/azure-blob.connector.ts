/**
 * ============================================================================
 * COGNIVANTA CLOUD CONNECTOR: AZUREBLOBSTORAGECONNECTOR
 * ============================================================================
...
export interface AzureBlobStorageConnectorConfig {
  connectionId: string;
...
export class AzureBlobStorageConnector {
  public readonly connectorId = 'azure-blob';
  public readonly category = 'storage';
  public readonly protocol = 'azure_storage_blob';
  private config: AzureBlobStorageConnectorConfig;

  constructor(config?: Partial<AzureBlobStorageConnectorConfig>) {
    this.config = {
...
export const azure_blobConnector = new AzureBlobStorageConnector();
