/**
 * ============================================================================
 * COGNIVANTA CLOUD CONNECTOR: BOXENTERPRISECONNECTOR
 * ============================================================================
...
export interface BoxEnterpriseConnectorConfig {
  connectionId: string;
...
export class BoxEnterpriseConnector {
  public readonly connectorId = 'box';
  public readonly category = 'document';
  public readonly protocol = 'box_enterprise_api';
  private config: BoxEnterpriseConnectorConfig;

  constructor(config?: Partial<BoxEnterpriseConnectorConfig>) {
    this.config = {
...
export const boxConnector = new BoxEnterpriseConnector();
