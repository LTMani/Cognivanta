/**
 * ============================================================================
 * COGNIVANTA CLOUD CONNECTOR: NOTIONWORKSPACECONNECTOR
 * ============================================================================
...
export interface NotionWorkspaceConnectorConfig {
  connectionId: string;
...
export class NotionWorkspaceConnector {
  public readonly connectorId = 'notion';
  public readonly category = 'saas';
  public readonly protocol = 'notion_api_v1';
  private config: NotionWorkspaceConnectorConfig;

  constructor(config?: Partial<NotionWorkspaceConnectorConfig>) {
    this.config = {
...
export const notionConnector = new NotionWorkspaceConnector();
