/**
 * ============================================================================
 * COGNIVANTA CLOUD CONNECTOR: ZENDESKSUPPORTCONNECTOR
 * ============================================================================
...
export interface ZendeskSupportConnectorConfig {
  connectionId: string;
...
export class ZendeskSupportConnector {
  public readonly connectorId = 'zendesk';
  public readonly category = 'saas';
  public readonly protocol = 'zendesk_v2';
  private config: ZendeskSupportConnectorConfig;

  constructor(config?: Partial<ZendeskSupportConnectorConfig>) {
    this.config = {
...
export const zendeskConnector = new ZendeskSupportConnector();
