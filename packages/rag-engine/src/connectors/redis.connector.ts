/**
 * ============================================================================
 * COGNIVANTA CLOUD CONNECTOR: REDISCACHECONNECTOR
 * ============================================================================
...
export interface RedisCacheConnectorConfig {
  connectionId: string;
...
export class RedisCacheConnector {
  public readonly connectorId = 'redis';
  public readonly category = 'cache';
  public readonly protocol = 'redis_resp';
  private config: RedisCacheConnectorConfig;

  constructor(config?: Partial<RedisCacheConnectorConfig>) {
    this.config = {
...
export const redisConnector = new RedisCacheConnector();
