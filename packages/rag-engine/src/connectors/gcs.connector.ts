/**
 * ============================================================================
 * COGNIVANTA DATA CONNECTOR: GCSSTORAGECONNECTOR
 * ============================================================================
 * Integration: Google Cloud Storage
 * Description: Ingests files and archives from GCP buckets with service account credentials.
 */
...
export class GCSStorageConnector {
