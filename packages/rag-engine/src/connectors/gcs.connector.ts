/**
 * ============================================================================
 * COGNIVANTA CLOUD CONNECTOR: GOOGLECLOUDSTORAGECONNECTOR
 * ============================================================================
...
export interface GoogleCloudStorageConnectorConfig {
  connectionId: string;
...
export class GoogleCloudStorageConnector {
  public readonly connectorId = 'gcs';
  public readonly category = 'storage';
  public readonly protocol = 'google_cloud_storage';
  private config: GoogleCloudStorageConnectorConfig;

  constructor(config?: Partial<GoogleCloudStorageConnectorConfig>) {
    this.config = {
...
export const gcsConnector = new GoogleCloudStorageConnector();
