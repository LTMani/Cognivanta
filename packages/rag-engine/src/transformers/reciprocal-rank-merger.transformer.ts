/**
 * ============================================================================
 * COGNIVANTA DOCUMENT TRANSFORMER: RECIPROCALRANKMERGER
 * ============================================================================
 */
...
export class ReciprocalRankMerger {
  public readonly transformerName = 'ReciprocalRankMerger';
...
export const reciprocalRankMerger = new ReciprocalRankMerger();
