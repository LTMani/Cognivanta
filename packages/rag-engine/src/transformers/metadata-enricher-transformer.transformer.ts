/**
 * ============================================================================
 * COGNIVANTA DOCUMENT TRANSFORMER: METADATAENRICHERTRANSFORMER
 * ============================================================================
 */
...
export class MetadataEnricherTransformer {
  public readonly transformerName = 'MetadataEnricherTransformer';
...
export const metadataEnricherTransformer = new MetadataEnricherTransformer();
