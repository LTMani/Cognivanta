/**
 * ============================================================================
 * COGNIVANTA DOCUMENT TRANSFORMER: CROSSREFERENCELINKER
 * ============================================================================
 */
...
export class CrossReferenceLinker {
  public readonly transformerName = 'CrossReferenceLinker';
...
export const crossReferenceLinker = new CrossReferenceLinker();
