/**
 * ============================================================================
 * COGNIVANTA DOCUMENT TRANSFORMER: ENTITYMASKINGTRANSFORMER
 * ============================================================================
 */
...
export class EntityMaskingTransformer {
  public readonly transformerName = 'EntityMaskingTransformer';
...
export const entityMaskingTransformer = new EntityMaskingTransformer();
