/**
 * ============================================================================
 * COGNIVANTA DOCUMENT TRANSFORMER: OCRBOUNDINGBOXALIGNER
 * ============================================================================
 */
...
export class OCRBoundingBoxAligner {
  public readonly transformerName = 'OCRBoundingBoxAligner';
...
export const oCRBoundingBoxAligner = new OCRBoundingBoxAligner();
