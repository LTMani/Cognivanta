/**
 * ============================================================================
 * COGNIVANTA DOCUMENT TRANSFORMER: CSVDELIMITEDNORMALIZER
 * ============================================================================
 */
...
export class CSVDelimitedNormalizer {
  public readonly transformerName = 'CSVDelimitedNormalizer';
...
export const cSVDelimitedNormalizer = new CSVDelimitedNormalizer();
