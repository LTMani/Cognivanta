/**
 * ============================================================================
 * COGNIVANTA DOCUMENT TRANSFORMER: CONTEXTUALWINDOWPADDER
 * ============================================================================
 */
...
export class ContextualWindowPadder {
  public readonly transformerName = 'ContextualWindowPadder';
...
export const contextualWindowPadder = new ContextualWindowPadder();
