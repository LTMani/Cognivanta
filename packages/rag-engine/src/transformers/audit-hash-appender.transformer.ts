/**
 * ============================================================================
 * COGNIVANTA DOCUMENT TRANSFORMER: AUDITHASHAPPENDER
 * ============================================================================
 */
...
export class AuditHashAppender {
  public readonly transformerName = 'AuditHashAppender';
...
export const auditHashAppender = new AuditHashAppender();
