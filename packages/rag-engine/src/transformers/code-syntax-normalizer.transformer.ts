/**
 * ============================================================================
 * COGNIVANTA DOCUMENT TRANSFORMER: CODESYNTAXNORMALIZER
 * ============================================================================
 */
...
export class CodeSyntaxNormalizer {
  public readonly transformerName = 'CodeSyntaxNormalizer';
...
export const codeSyntaxNormalizer = new CodeSyntaxNormalizer();
