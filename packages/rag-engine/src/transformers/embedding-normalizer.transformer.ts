/**
 * ============================================================================
 * COGNIVANTA DOCUMENT TRANSFORMER: EMBEDDINGNORMALIZER
 * ============================================================================
 */
...
export class EmbeddingNormalizer {
  public readonly transformerName = 'EmbeddingNormalizer';
...
export const embeddingNormalizer = new EmbeddingNormalizer();
