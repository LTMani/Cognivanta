/**
 * ============================================================================
 * COGNIVANTA DOCUMENT TRANSFORMER: DOCUMENTWATERMARKREMOVER
 * ============================================================================
 */
...
export class DocumentWatermarkRemover {
  public readonly transformerName = 'DocumentWatermarkRemover';
...
export const documentWatermarkRemover = new DocumentWatermarkRemover();
