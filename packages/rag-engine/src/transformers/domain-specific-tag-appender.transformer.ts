/**
 * ============================================================================
 * COGNIVANTA DOCUMENT TRANSFORMER: DOMAINSPECIFICTAGAPPENDER
 * ============================================================================
 */
...
export class DomainSpecificTagAppender {
  public readonly transformerName = 'DomainSpecificTagAppender';
...
export const domainSpecificTagAppender = new DomainSpecificTagAppender();
