/**
 * ============================================================================
 * COGNIVANTA DOCUMENT TRANSFORMER: SENTENCEBOUNDARYSPLITTER
 * ============================================================================
 */
...
export class SentenceBoundarySplitter {
  public readonly transformerName = 'SentenceBoundarySplitter';
...
export const sentenceBoundarySplitter = new SentenceBoundarySplitter();
