/**
 * ============================================================================
 * COGNIVANTA DOCUMENT TRANSFORMER: MATHEMATICALEQUATIONPARSER
 * ============================================================================
 */
...
export class MathematicalEquationParser {
  public readonly transformerName = 'MathematicalEquationParser';
...
export const mathematicalEquationParser = new MathematicalEquationParser();
