/**
 * ============================================================================
 * COGNIVANTA DOCUMENT TRANSFORMER: NGRAMVECTORTRANSFORMER
 * ============================================================================
 */
...
export class NgramVectorTransformer {
  public readonly transformerName = 'NgramVectorTransformer';
...
export const ngramVectorTransformer = new NgramVectorTransformer();
