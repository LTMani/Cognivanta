/**
 * ============================================================================
 * COGNIVANTA DOCUMENT TRANSFORMER: JSONSCHEMAFLATTENER
 * ============================================================================
 */
...
export class JSONSchemaFlattener {
  public readonly transformerName = 'JSONSchemaFlattener';
...
export const jSONSchemaFlattener = new JSONSchemaFlattener();
