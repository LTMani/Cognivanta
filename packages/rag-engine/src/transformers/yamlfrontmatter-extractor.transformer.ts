/**
 * ============================================================================
 * COGNIVANTA DOCUMENT TRANSFORMER: YAMLFRONTMATTEREXTRACTOR
 * ============================================================================
 */
...
export class YAMLFrontmatterExtractor {
  public readonly transformerName = 'YAMLFrontmatterExtractor';
...
export const yAMLFrontmatterExtractor = new YAMLFrontmatterExtractor();
