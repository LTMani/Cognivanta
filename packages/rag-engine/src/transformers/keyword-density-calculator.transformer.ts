/**
 * ============================================================================
 * COGNIVANTA DOCUMENT TRANSFORMER: KEYWORDDENSITYCALCULATOR
 * ============================================================================
 */
...
export class KeywordDensityCalculator {
  public readonly transformerName = 'KeywordDensityCalculator';
...
export const keywordDensityCalculator = new KeywordDensityCalculator();
