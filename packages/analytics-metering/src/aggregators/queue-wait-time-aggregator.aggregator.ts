/**
 * ============================================================================
 * COGNIVANTA ANALYTICS AGGREGATOR: QUEUEWAITTIMEAGGREGATOR
 * ============================================================================
 */
...
export class QueueWaitTimeAggregator {
  public readonly aggregatorName = 'QueueWaitTimeAggregator';
...
export const queueWaitTimeAggregator = new QueueWaitTimeAggregator();
