/**
 * ============================================================================
 * COGNIVANTA ANALYTICS AGGREGATOR: CONCURRENTSESSIONSAGGREGATOR
 * ============================================================================
 */
...
export class ConcurrentSessionsAggregator {
  public readonly aggregatorName = 'ConcurrentSessionsAggregator';
...
export const concurrentSessionsAggregator = new ConcurrentSessionsAggregator();
