/**
 * ============================================================================
 * COGNIVANTA ANALYTICS AGGREGATOR: EVALUATIONSCORETRENDAGGREGATOR
 * ============================================================================
 */
...
export class EvaluationScoreTrendAggregator {
  public readonly aggregatorName = 'EvaluationScoreTrendAggregator';
...
export const evaluationScoreTrendAggregator = new EvaluationScoreTrendAggregator();
