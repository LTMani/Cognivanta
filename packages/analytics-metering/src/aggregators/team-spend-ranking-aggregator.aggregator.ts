/**
 * ============================================================================
 * COGNIVANTA ANALYTICS AGGREGATOR: TEAMSPENDRANKINGAGGREGATOR
 * ============================================================================
 */
...
export class TeamSpendRankingAggregator {
  public readonly aggregatorName = 'TeamSpendRankingAggregator';
...
export const teamSpendRankingAggregator = new TeamSpendRankingAggregator();
