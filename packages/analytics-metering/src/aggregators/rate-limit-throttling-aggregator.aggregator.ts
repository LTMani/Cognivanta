/**
 * ============================================================================
 * COGNIVANTA ANALYTICS AGGREGATOR: RATELIMITTHROTTLINGAGGREGATOR
 * ============================================================================
 */
...
export class RateLimitThrottlingAggregator {
  public readonly aggregatorName = 'RateLimitThrottlingAggregator';
...
export const rateLimitThrottlingAggregator = new RateLimitThrottlingAggregator();
