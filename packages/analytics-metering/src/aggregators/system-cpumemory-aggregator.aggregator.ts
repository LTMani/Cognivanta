/**
 * ============================================================================
 * COGNIVANTA ANALYTICS AGGREGATOR: SYSTEMCPUMEMORYAGGREGATOR
 * ============================================================================
 */
...
export class SystemCPUMemoryAggregator {
  public readonly aggregatorName = 'SystemCPUMemoryAggregator';
...
export const systemCPUMemoryAggregator = new SystemCPUMemoryAggregator();
