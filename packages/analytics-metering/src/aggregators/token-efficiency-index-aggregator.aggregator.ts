/**
 * ============================================================================
 * COGNIVANTA ANALYTICS AGGREGATOR: TOKENEFFICIENCYINDEXAGGREGATOR
 * ============================================================================
 */
...
export class TokenEfficiencyIndexAggregator {
  public readonly aggregatorName = 'TokenEfficiencyIndexAggregator';
...
export const tokenEfficiencyIndexAggregator = new TokenEfficiencyIndexAggregator();
