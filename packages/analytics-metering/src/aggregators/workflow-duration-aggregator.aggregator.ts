/**
 * ============================================================================
 * COGNIVANTA ANALYTICS AGGREGATOR: WORKFLOWDURATIONAGGREGATOR
 * ============================================================================
 */
...
export class WorkflowDurationAggregator {
  public readonly aggregatorName = 'WorkflowDurationAggregator';
...
export const workflowDurationAggregator = new WorkflowDurationAggregator();
