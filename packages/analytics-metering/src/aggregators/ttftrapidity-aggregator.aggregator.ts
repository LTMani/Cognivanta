/**
 * ============================================================================
 * COGNIVANTA ANALYTICS AGGREGATOR: TTFTRAPIDITYAGGREGATOR
 * ============================================================================
 */
...
export class TTFTRapidityAggregator {
  public readonly aggregatorName = 'TTFTRapidityAggregator';
...
export const tTFTRapidityAggregator = new TTFTRapidityAggregator();
