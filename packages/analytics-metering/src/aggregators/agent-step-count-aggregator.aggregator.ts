/**
 * ============================================================================
 * COGNIVANTA ANALYTICS AGGREGATOR: AGENTSTEPCOUNTAGGREGATOR
 * ============================================================================
 */
...
export class AgentStepCountAggregator {
  public readonly aggregatorName = 'AgentStepCountAggregator';
...
export const agentStepCountAggregator = new AgentStepCountAggregator();
