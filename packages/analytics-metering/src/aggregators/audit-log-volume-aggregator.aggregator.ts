/**
 * ============================================================================
 * COGNIVANTA ANALYTICS AGGREGATOR: AUDITLOGVOLUMEAGGREGATOR
 * ============================================================================
 */
...
export class AuditLogVolumeAggregator {
  public readonly aggregatorName = 'AuditLogVolumeAggregator';
...
export const auditLogVolumeAggregator = new AuditLogVolumeAggregator();
