/**
 * ============================================================================
 * COGNIVANTA ANALYTICS AGGREGATOR: STORAGECAPACITYAGGREGATOR
 * ============================================================================
 */
...
export class StorageCapacityAggregator {
  public readonly aggregatorName = 'StorageCapacityAggregator';
...
export const storageCapacityAggregator = new StorageCapacityAggregator();
