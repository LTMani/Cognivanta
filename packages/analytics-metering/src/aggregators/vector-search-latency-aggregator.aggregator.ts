/**
 * ============================================================================
 * COGNIVANTA ANALYTICS AGGREGATOR: VECTORSEARCHLATENCYAGGREGATOR
 * ============================================================================
 */
...
export class VectorSearchLatencyAggregator {
  public readonly aggregatorName = 'VectorSearchLatencyAggregator';
...
export const vectorSearchLatencyAggregator = new VectorSearchLatencyAggregator();
