/**
 * ============================================================================
 * COGNIVANTA ANALYTICS AGGREGATOR: HTTPSTATUSDISTRIBUTIONAGGREGATOR
 * ============================================================================
 */
...
export class HTTPStatusDistributionAggregator {
  public readonly aggregatorName = 'HTTPStatusDistributionAggregator';
...
export const hTTPStatusDistributionAggregator = new HTTPStatusDistributionAggregator();
