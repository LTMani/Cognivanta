/**
 * ============================================================================
 * COGNIVANTA ANALYTICS AGGREGATOR: PROMPTTOKENRATIOAGGREGATOR
 * ============================================================================
 */
...
export class PromptTokenRatioAggregator {
  public readonly aggregatorName = 'PromptTokenRatioAggregator';
...
export const promptTokenRatioAggregator = new PromptTokenRatioAggregator();
