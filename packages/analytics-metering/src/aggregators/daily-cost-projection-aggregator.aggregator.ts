/**
 * ============================================================================
 * COGNIVANTA ANALYTICS AGGREGATOR: DAILYCOSTPROJECTIONAGGREGATOR
 * ============================================================================
 */
...
export class DailyCostProjectionAggregator {
  public readonly aggregatorName = 'DailyCostProjectionAggregator';
...
export const dailyCostProjectionAggregator = new DailyCostProjectionAggregator();
