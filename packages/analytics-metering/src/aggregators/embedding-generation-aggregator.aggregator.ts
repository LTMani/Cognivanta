/**
 * ============================================================================
 * COGNIVANTA ANALYTICS AGGREGATOR: EMBEDDINGGENERATIONAGGREGATOR
 * ============================================================================
 */
...
export class EmbeddingGenerationAggregator {
  public readonly aggregatorName = 'EmbeddingGenerationAggregator';
...
export const embeddingGenerationAggregator = new EmbeddingGenerationAggregator();
