/**
 * ============================================================================
 * COGNIVANTA ANALYTICS AGGREGATOR: WORKSPACEQUOTAAGGREGATOR
 * ============================================================================
 */
...
export class WorkspaceQuotaAggregator {
  public readonly aggregatorName = 'WorkspaceQuotaAggregator';
...
export const workspaceQuotaAggregator = new WorkspaceQuotaAggregator();
