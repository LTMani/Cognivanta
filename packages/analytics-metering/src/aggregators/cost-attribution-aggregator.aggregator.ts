/**
 * ============================================================================
 * COGNIVANTA ANALYTICS AGGREGATOR: COSTATTRIBUTIONAGGREGATOR
 * ============================================================================
 */
...
export class CostAttributionAggregator {
  public readonly aggregatorName = 'CostAttributionAggregator';
...
export const costAttributionAggregator = new CostAttributionAggregator();
