/**
 * ============================================================================
 * COGNIVANTA ANALYTICS AGGREGATOR: CACHEHITRATEAGGREGATOR
 * ============================================================================
 */
...
export class CacheHitRateAggregator {
  public readonly aggregatorName = 'CacheHitRateAggregator';
...
export const cacheHitRateAggregator = new CacheHitRateAggregator();
