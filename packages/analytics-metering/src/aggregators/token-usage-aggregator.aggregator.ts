/**
 * ============================================================================
 * COGNIVANTA ANALYTICS AGGREGATOR: TOKENUSAGEAGGREGATOR
 * ============================================================================
 */
...
export class TokenUsageAggregator {
  public readonly aggregatorName = 'TokenUsageAggregator';
...
export const tokenUsageAggregator = new TokenUsageAggregator();
