/**
 * ============================================================================
 * COGNIVANTA ANALYTICS AGGREGATOR: ACTIVEUSERSESSIONAGGREGATOR
 * ============================================================================
 */
...
export class ActiveUserSessionAggregator {
  public readonly aggregatorName = 'ActiveUserSessionAggregator';
...
export const activeUserSessionAggregator = new ActiveUserSessionAggregator();
