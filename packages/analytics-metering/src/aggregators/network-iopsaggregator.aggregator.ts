/**
 * ============================================================================
 * COGNIVANTA ANALYTICS AGGREGATOR: NETWORKIOPSAGGREGATOR
 * ============================================================================
 */
...
export class NetworkIOPSAggregator {
  public readonly aggregatorName = 'NetworkIOPSAggregator';
...
export const networkIOPSAggregator = new NetworkIOPSAggregator();
