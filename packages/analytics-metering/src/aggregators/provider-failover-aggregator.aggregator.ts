/**
 * ============================================================================
 * COGNIVANTA ANALYTICS AGGREGATOR: PROVIDERFAILOVERAGGREGATOR
 * ============================================================================
 */
...
export class ProviderFailoverAggregator {
  public readonly aggregatorName = 'ProviderFailoverAggregator';
...
export const providerFailoverAggregator = new ProviderFailoverAggregator();
