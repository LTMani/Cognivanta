/**
 * ============================================================================
 * COGNIVANTA ANALYTICS AGGREGATOR: MODELTHROUGHPUTAGGREGATOR
 * ============================================================================
 */
...
export class ModelThroughputAggregator {
  public readonly aggregatorName = 'ModelThroughputAggregator';
...
export const modelThroughputAggregator = new ModelThroughputAggregator();
