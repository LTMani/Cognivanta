/**
 * ============================================================================
 * COGNIVANTA ANALYTICS AGGREGATOR: HOURLYTOKENBURNAGGREGATOR
 * ============================================================================
 */
...
export class HourlyTokenBurnAggregator {
  public readonly aggregatorName = 'HourlyTokenBurnAggregator';
...
export const hourlyTokenBurnAggregator = new HourlyTokenBurnAggregator();
