/**
 * ============================================================================
 * COGNIVANTA ANALYTICS AGGREGATOR: DLPINCIDENTFREQUENCYAGGREGATOR
 * ============================================================================
 */
...
export class DLPIncidentFrequencyAggregator {
  public readonly aggregatorName = 'DLPIncidentFrequencyAggregator';
...
export const dLPIncidentFrequencyAggregator = new DLPIncidentFrequencyAggregator();
