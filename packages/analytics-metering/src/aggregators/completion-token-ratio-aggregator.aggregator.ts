/**
 * ============================================================================
 * COGNIVANTA ANALYTICS AGGREGATOR: COMPLETIONTOKENRATIOAGGREGATOR
 * ============================================================================
 */
...
export class CompletionTokenRatioAggregator {
  public readonly aggregatorName = 'CompletionTokenRatioAggregator';
...
export const completionTokenRatioAggregator = new CompletionTokenRatioAggregator();
