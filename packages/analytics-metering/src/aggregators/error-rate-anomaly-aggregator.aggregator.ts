/**
 * ============================================================================
 * COGNIVANTA ANALYTICS AGGREGATOR: ERRORRATEANOMALYAGGREGATOR
 * ============================================================================
 */
...
export class ErrorRateAnomalyAggregator {
  public readonly aggregatorName = 'ErrorRateAnomalyAggregator';
...
export const errorRateAnomalyAggregator = new ErrorRateAnomalyAggregator();
