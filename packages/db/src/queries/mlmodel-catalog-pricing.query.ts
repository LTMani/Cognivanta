/**
 * ============================================================================
 * COGNIVANTA QUERY PLANNER: MLMODELCATALOGPRICING
 * ============================================================================
...
export interface MLModelCatalogPricingQueryParams {
...
export interface MLModelCatalogPricingQueryResult<T = unknown> {
  queryId: string;
  records: T[];
  totalCount: number;
...
export class MLModelCatalogPricingQueryPlanner {
  public readonly queryName = 'MLModelCatalogPricing';

  public buildSQL(params: MLModelCatalogPricingQueryParams): { sql: string; bindings: unknown[] } {
  ...
  public async execute(params: MLModelCatalogPricingQueryParams): Promise<MLModelCatalogPricingQueryResult> {
...
export const mLModelCatalogPricingQueryPlanner = new MLModelCatalogPricingQueryPlanner();
