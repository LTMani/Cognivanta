/**
 * ============================================================================
 * COGNIVANTA QUERY PLANNER: SEMANTICCACHELOOKUP
 * ============================================================================
...
export interface SemanticCacheLookupQueryParams {
...
export interface SemanticCacheLookupQueryResult<T = unknown> {
  queryId: string;
  records: T[];
  totalCount: number;
...
export class SemanticCacheLookupQueryPlanner {
  public readonly queryName = 'SemanticCacheLookup';

  public buildSQL(params: SemanticCacheLookupQueryParams): { sql: string; bindings: unknown[] } {
  ...
  public async execute(params: SemanticCacheLookupQueryParams): Promise<SemanticCacheLookupQueryResult> {
...
export const semanticCacheLookupQueryPlanner = new SemanticCacheLookupQueryPlanner();
