/**
 * ============================================================================
 * COGNIVANTA QUERY PLANNER: KNOWLEDGESPACEHIERARCHY
 * ============================================================================
...
export interface KnowledgeSpaceHierarchyQueryParams {
...
export interface KnowledgeSpaceHierarchyQueryResult<T = unknown> {
  queryId: string;
  records: T[];
  totalCount: number;
...
export class KnowledgeSpaceHierarchyQueryPlanner {
  public readonly queryName = 'KnowledgeSpaceHierarchy';

  public buildSQL(params: KnowledgeSpaceHierarchyQueryParams): { sql: string; bindings: unknown[] } {
  ...
  public async execute(params: KnowledgeSpaceHierarchyQueryParams): Promise<KnowledgeSpaceHierarchyQueryResult> {
...
export const knowledgeSpaceHierarchyQueryPlanner = new KnowledgeSpaceHierarchyQueryPlanner();
