/**
 * ============================================================================
 * COGNIVANTA QUERY PLANNER: MULTITENANTPARTITION
 * ============================================================================
...
export interface MultiTenantPartitionQueryParams {
...
export interface MultiTenantPartitionQueryResult<T = unknown> {
  queryId: string;
  records: T[];
  totalCount: number;
...
export class MultiTenantPartitionQueryPlanner {
  public readonly queryName = 'MultiTenantPartition';

  public buildSQL(params: MultiTenantPartitionQueryParams): { sql: string; bindings: unknown[] } {
  ...
  public async execute(params: MultiTenantPartitionQueryParams): Promise<MultiTenantPartitionQueryResult> {
...
export const multiTenantPartitionQueryPlanner = new MultiTenantPartitionQueryPlanner();
