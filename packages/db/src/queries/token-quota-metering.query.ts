/**
 * ============================================================================
 * COGNIVANTA QUERY PLANNER: TOKENQUOTAMETERING
 * ============================================================================
...
export interface TokenQuotaMeteringQueryParams {
...
export interface TokenQuotaMeteringQueryResult<T = unknown> {
  queryId: string;
  records: T[];
  totalCount: number;
...
export class TokenQuotaMeteringQueryPlanner {
  public readonly queryName = 'TokenQuotaMetering';

  public buildSQL(params: TokenQuotaMeteringQueryParams): { sql: string; bindings: unknown[] } {
  ...
  public async execute(params: TokenQuotaMeteringQueryParams): Promise<TokenQuotaMeteringQueryResult> {
...
export const tokenQuotaMeteringQueryPlanner = new TokenQuotaMeteringQueryPlanner();
