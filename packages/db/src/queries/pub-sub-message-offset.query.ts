/**
 * ============================================================================
 * COGNIVANTA QUERY PLANNER: PUBSUBMESSAGEOFFSET
 * ============================================================================
...
export interface PubSubMessageOffsetQueryParams {
...
export interface PubSubMessageOffsetQueryResult<T = unknown> {
  queryId: string;
  records: T[];
  totalCount: number;
...
export class PubSubMessageOffsetQueryPlanner {
  public readonly queryName = 'PubSubMessageOffset';

  public buildSQL(params: PubSubMessageOffsetQueryParams): { sql: string; bindings: unknown[] } {
  ...
  public async execute(params: PubSubMessageOffsetQueryParams): Promise<PubSubMessageOffsetQueryResult> {
...
export const pubSubMessageOffsetQueryPlanner = new PubSubMessageOffsetQueryPlanner();
