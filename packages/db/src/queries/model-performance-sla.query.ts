/**
 * ============================================================================
 * COGNIVANTA QUERY PLANNER: MODELPERFORMANCESLA
 * ============================================================================
...
export interface ModelPerformanceSLAQueryParams {
...
export interface ModelPerformanceSLAQueryResult<T = unknown> {
  queryId: string;
  records: T[];
  totalCount: number;
...
export class ModelPerformanceSLAQueryPlanner {
  public readonly queryName = 'ModelPerformanceSLA';

  public buildSQL(params: ModelPerformanceSLAQueryParams): { sql: string; bindings: unknown[] } {
  ...
  public async execute(params: ModelPerformanceSLAQueryParams): Promise<ModelPerformanceSLAQueryResult> {
...
export const modelPerformanceSLAQueryPlanner = new ModelPerformanceSLAQueryPlanner();
