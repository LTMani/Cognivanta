/**
 * ============================================================================
 * COGNIVANTA QUERY PLANNER: AUDITCHAININTEGRITY
 * ============================================================================
...
export interface AuditChainIntegrityQueryParams {
...
export interface AuditChainIntegrityQueryResult<T = unknown> {
  queryId: string;
  records: T[];
  totalCount: number;
...
export class AuditChainIntegrityQueryPlanner {
  public readonly queryName = 'AuditChainIntegrity';

  public buildSQL(params: AuditChainIntegrityQueryParams): { sql: string; bindings: unknown[] } {
  ...
  public async execute(params: AuditChainIntegrityQueryParams): Promise<AuditChainIntegrityQueryResult> {
...
export const auditChainIntegrityQueryPlanner = new AuditChainIntegrityQueryPlanner();
