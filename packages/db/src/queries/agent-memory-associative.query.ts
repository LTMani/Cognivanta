/**
 * ============================================================================
 * COGNIVANTA QUERY PLANNER: AGENTMEMORYASSOCIATIVE
 * ============================================================================
...
export interface AgentMemoryAssociativeQueryParams {
...
export interface AgentMemoryAssociativeQueryResult<T = unknown> {
  queryId: string;
  records: T[];
  totalCount: number;
...
export class AgentMemoryAssociativeQueryPlanner {
  public readonly queryName = 'AgentMemoryAssociative';

  public buildSQL(params: AgentMemoryAssociativeQueryParams): { sql: string; bindings: unknown[] } {
  ...
  public async execute(params: AgentMemoryAssociativeQueryParams): Promise<AgentMemoryAssociativeQueryResult> {
...
export const agentMemoryAssociativeQueryPlanner = new AgentMemoryAssociativeQueryPlanner();
