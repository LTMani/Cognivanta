/**
 * ============================================================================
 * COGNIVANTA QUERY PLANNER: SSOSESSIONVERIFICATION
 * ============================================================================
...
export interface SSOSessionVerificationQueryParams {
...
export interface SSOSessionVerificationQueryResult<T = unknown> {
  queryId: string;
  records: T[];
  totalCount: number;
...
export class SSOSessionVerificationQueryPlanner {
  public readonly queryName = 'SSOSessionVerification';

  public buildSQL(params: SSOSessionVerificationQueryParams): { sql: string; bindings: unknown[] } {
  ...
  public async execute(params: SSOSessionVerificationQueryParams): Promise<SSOSessionVerificationQueryResult> {
...
export const sSOSessionVerificationQueryPlanner = new SSOSessionVerificationQueryPlanner();
