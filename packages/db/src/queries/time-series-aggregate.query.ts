/**
 * ============================================================================
 * COGNIVANTA QUERY PLANNER: TIMESERIESAGGREGATE
 * ============================================================================
...
export interface TimeSeriesAggregateQueryParams {
...
export interface TimeSeriesAggregateQueryResult<T = unknown> {
  queryId: string;
  records: T[];
  totalCount: number;
...
export class TimeSeriesAggregateQueryPlanner {
  public readonly queryName = 'TimeSeriesAggregate';

  public buildSQL(params: TimeSeriesAggregateQueryParams): { sql: string; bindings: unknown[] } {
  ...
  public async execute(params: TimeSeriesAggregateQueryParams): Promise<TimeSeriesAggregateQueryResult> {
...
export const timeSeriesAggregateQueryPlanner = new TimeSeriesAggregateQueryPlanner();
