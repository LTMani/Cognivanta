/**
 * ============================================================================
 * COGNIVANTA QUERY PLANNER: ORGANIZATIONBILLINGINVOICE
 * ============================================================================
...
export interface OrganizationBillingInvoiceQueryParams {
...
export interface OrganizationBillingInvoiceQueryResult<T = unknown> {
  queryId: string;
  records: T[];
  totalCount: number;
...
export class OrganizationBillingInvoiceQueryPlanner {
  public readonly queryName = 'OrganizationBillingInvoice';

  public buildSQL(params: OrganizationBillingInvoiceQueryParams): { sql: string; bindings: unknown[] } {
  ...
  public async execute(params: OrganizationBillingInvoiceQueryParams): Promise<OrganizationBillingInvoiceQueryResult> {
    ...
    return {
      ...
      records: [
        {
          id: 'organizationbillinginvoice-1',
...
export const organizationBillingInvoiceQueryPlanner = new OrganizationBillingInvoiceQueryPlanner();
