/**
 * ============================================================================
 * COGNIVANTA QUERY PLANNER: APIKEYSCOPEVERIFICATION
 * ============================================================================
...
export interface APIKeyScopeVerificationQueryParams {
...
export interface APIKeyScopeVerificationQueryResult<T = unknown> {
  queryId: string;
  records: T[];
  totalCount: number;
...
export class APIKeyScopeVerificationQueryPlanner {
  public readonly queryName = 'APIKeyScopeVerification';

  public buildSQL(params: APIKeyScopeVerificationQueryParams): { sql: string; bindings: unknown[] } {
  ...
  public async execute(params: APIKeyScopeVerificationQueryParams): Promise<APIKeyScopeVerificationQueryResult> {
...
export const aPIKeyScopeVerificationQueryPlanner = new APIKeyScopeVerificationQueryPlanner();
