/**
 * ============================================================================
 * COGNIVANTA QUERY PLANNER: VECTORHYBRIDSEARCH
 * ============================================================================
...
export interface VectorHybridSearchQueryParams {
...
export interface VectorHybridSearchQueryResult<T = unknown> {
  queryId: string;
  records: T[];
  totalCount: number;
...
export class VectorHybridSearchQueryPlanner {
  public readonly queryName = 'VectorHybridSearch';

  public buildSQL(params: VectorHybridSearchQueryParams): { sql: string; bindings: unknown[] } {
  ...
  public async execute(params: VectorHybridSearchQueryParams): Promise<VectorHybridSearchQueryResult> {
...
export const vectorHybridSearchQueryPlanner = new VectorHybridSearchQueryPlanner();
