/**
 * ============================================================================
 * COGNIVANTA QUERY PLANNER: COSTATTRIBUTIONBREAKDOWN
 * ============================================================================
...
export interface CostAttributionBreakdownQueryParams {
...
export interface CostAttributionBreakdownQueryResult<T = unknown> {
  queryId: string;
  records: T[];
  totalCount: number;
...
export class CostAttributionBreakdownQueryPlanner {
  public readonly queryName = 'CostAttributionBreakdown';

  public buildSQL(params: CostAttributionBreakdownQueryParams): { sql: string; bindings: unknown[] } {
  ...
  public async execute(params: CostAttributionBreakdownQueryParams): Promise<CostAttributionBreakdownQueryResult> {
...
export const costAttributionBreakdownQueryPlanner = new CostAttributionBreakdownQueryPlanner();
