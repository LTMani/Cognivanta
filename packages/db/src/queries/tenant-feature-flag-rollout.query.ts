/**
 * ============================================================================
 * COGNIVANTA QUERY PLANNER: TENANTFEATUREFLAGROLLOUT
 * ============================================================================
...
export interface TenantFeatureFlagRolloutQueryParams {
...
export interface TenantFeatureFlagRolloutQueryResult<T = unknown> {
  queryId: string;
  records: T[];
  totalCount: number;
...
export class TenantFeatureFlagRolloutQueryPlanner {
  public readonly queryName = 'TenantFeatureFlagRollout';

  public buildSQL(params: TenantFeatureFlagRolloutQueryParams): { sql: string; bindings: unknown[] } {
  ...
  public async execute(params: TenantFeatureFlagRolloutQueryParams): Promise<TenantFeatureFlagRolloutQueryResult> {
...
export const tenantFeatureFlagRolloutQueryPlanner = new TenantFeatureFlagRolloutQueryPlanner();
