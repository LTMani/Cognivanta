/**
 * ============================================================================
 * COGNIVANTA QUERY PLANNER: SYSTEMNODETELEMETRY
 * ============================================================================
...
export interface SystemNodeTelemetryQueryParams {
...
export interface SystemNodeTelemetryQueryResult<T = unknown> {
  queryId: string;
  records: T[];
  totalCount: number;
...
export class SystemNodeTelemetryQueryPlanner {
  public readonly queryName = 'SystemNodeTelemetry';

  public buildSQL(params: SystemNodeTelemetryQueryParams): { sql: string; bindings: unknown[] } {
  ...
  public async execute(params: SystemNodeTelemetryQueryParams): Promise<SystemNodeTelemetryQueryResult> {
...
export const systemNodeTelemetryQueryPlanner = new SystemNodeTelemetryQueryPlanner();
