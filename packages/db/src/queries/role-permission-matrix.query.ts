/**
 * ============================================================================
 * COGNIVANTA QUERY PLANNER: ROLEPERMISSIONMATRIX
 * ============================================================================
...
export interface RolePermissionMatrixQueryParams {
...
export interface RolePermissionMatrixQueryResult<T = unknown> {
  queryId: string;
  records: T[];
  totalCount: number;
...
export class RolePermissionMatrixQueryPlanner {
  public readonly queryName = 'RolePermissionMatrix';

  public buildSQL(params: RolePermissionMatrixQueryParams): { sql: string; bindings: unknown[] } {
  ...
  public async execute(params: RolePermissionMatrixQueryParams): Promise<RolePermissionMatrixQueryResult> {
...
export const rolePermissionMatrixQueryPlanner = new RolePermissionMatrixQueryPlanner();
