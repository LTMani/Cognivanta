/**
 * ============================================================================
 * COGNIVANTA QUERY PLANNER: AGENTEXECUTIONTRACE
 * ============================================================================
...
export interface AgentExecutionTraceQueryParams {
...
export interface AgentExecutionTraceQueryResult<T = unknown> {
  queryId: string;
  records: T[];
  totalCount: number;
...
export class AgentExecutionTraceQueryPlanner {
  public readonly queryName = 'AgentExecutionTrace';

  public buildSQL(params: AgentExecutionTraceQueryParams): { sql: string; bindings: unknown[] } {
  ...
  public async execute(params: AgentExecutionTraceQueryParams): Promise<AgentExecutionTraceQueryResult> {
...
export const agentExecutionTraceQueryPlanner = new AgentExecutionTraceQueryPlanner();
