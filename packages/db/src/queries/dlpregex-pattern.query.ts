/**
 * ============================================================================
 * COGNIVANTA QUERY PLANNER: DLPREGEXPATTERN
 * ============================================================================
...
export interface DLPRegexPatternQueryParams {
...
export interface DLPRegexPatternQueryResult<T = unknown> {
  queryId: string;
  records: T[];
  totalCount: number;
...
export class DLPRegexPatternQueryPlanner {
  public readonly queryName = 'DLPRegexPattern';

  public buildSQL(params: DLPRegexPatternQueryParams): { sql: string; bindings: unknown[] } {
  ...
  public async execute(params: DLPRegexPatternQueryParams): Promise<DLPRegexPatternQueryResult> {
...
export const dLPRegexPatternQueryPlanner = new DLPRegexPatternQueryPlanner();
