/**
 * ============================================================================
 * COGNIVANTA QUERY PLANNER: FINETUNINGLOSSCHECKPOINT
 * ============================================================================
...
export interface FineTuningLossCheckpointQueryParams {
...
export interface FineTuningLossCheckpointQueryResult<T = unknown> {
  queryId: string;
  records: T[];
  totalCount: number;
...
export class FineTuningLossCheckpointQueryPlanner {
  public readonly queryName = 'FineTuningLossCheckpoint';

  public buildSQL(params: FineTuningLossCheckpointQueryParams): { sql: string; bindings: unknown[] } {
  ...
  public async execute(params: FineTuningLossCheckpointQueryParams): Promise<FineTuningLossCheckpointQueryResult> {
...
export const fineTuningLossCheckpointQueryPlanner = new FineTuningLossCheckpointQueryPlanner();
