/**
 * ============================================================================
 * COGNIVANTA QUERY PLANNER: NOTIFICATIONDELIVERYLOG
 * ============================================================================
...
export interface NotificationDeliveryLogQueryParams {
...
export interface NotificationDeliveryLogQueryResult<T = unknown> {
  queryId: string;
  records: T[];
  totalCount: number;
...
export class NotificationDeliveryLogQueryPlanner {
  public readonly queryName = 'NotificationDeliveryLog';

  public buildSQL(params: NotificationDeliveryLogQueryParams): { sql: string; bindings: unknown[] } {
  ...
  public async execute(params: NotificationDeliveryLogQueryParams): Promise<NotificationDeliveryLogQueryResult> {
...
export const notificationDeliveryLogQueryPlanner = new NotificationDeliveryLogQueryPlanner();
