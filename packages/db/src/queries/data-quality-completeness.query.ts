/**
 * ============================================================================
 * COGNIVANTA QUERY PLANNER: DATAQUALITYCOMPLETENESS
 * ============================================================================
...
export interface DataQualityCompletenessQueryParams {
...
export interface DataQualityCompletenessQueryResult<T = unknown> {
  queryId: string;
  records: T[];
  totalCount: number;
...
export class DataQualityCompletenessQueryPlanner {
  public readonly queryName = 'DataQualityCompleteness';

  public buildSQL(params: DataQualityCompletenessQueryParams): { sql: string; bindings: unknown[] } {
  ...
  public async execute(params: DataQualityCompletenessQueryParams): Promise<DataQualityCompletenessQueryResult> {
...
export const dataQualityCompletenessQueryPlanner = new DataQualityCompletenessQueryPlanner();
