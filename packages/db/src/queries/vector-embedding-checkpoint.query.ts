/**
 * ============================================================================
 * COGNIVANTA QUERY PLANNER: VECTOREMBEDDINGCHECKPOINT
 * ============================================================================
...
export interface VectorEmbeddingCheckpointQueryParams {
...
export interface VectorEmbeddingCheckpointQueryResult<T = unknown> {
  queryId: string;
  records: T[];
  totalCount: number;
...
export class VectorEmbeddingCheckpointQueryPlanner {
  public readonly queryName = 'VectorEmbeddingCheckpoint';

  public buildSQL(params: VectorEmbeddingCheckpointQueryParams): { sql: string; bindings: unknown[] } {
  ...
  public async execute(params: VectorEmbeddingCheckpointQueryParams): Promise<VectorEmbeddingCheckpointQueryResult> {
...
export const vectorEmbeddingCheckpointQueryPlanner = new VectorEmbeddingCheckpointQueryPlanner();
