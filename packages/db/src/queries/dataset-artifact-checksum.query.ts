/**
 * ============================================================================
 * COGNIVANTA QUERY PLANNER: DATASETARTIFACTCHECKSUM
 * ============================================================================
...
export interface DatasetArtifactChecksumQueryParams {
...
export interface DatasetArtifactChecksumQueryResult<T = unknown> {
  queryId: string;
  records: T[];
  totalCount: number;
...
export class DatasetArtifactChecksumQueryPlanner {
  public readonly queryName = 'DatasetArtifactChecksum';

  public buildSQL(params: DatasetArtifactChecksumQueryParams): { sql: string; bindings: unknown[] } {
  ...
  public async execute(params: DatasetArtifactChecksumQueryParams): Promise<DatasetArtifactChecksumQueryResult> {
...
export const datasetArtifactChecksumQueryPlanner = new DatasetArtifactChecksumQueryPlanner();
