/**
 * ============================================================================
 * COGNIVANTA QUERY PLANNER: EVALUATIONBENCHMARKSCORE
 * ============================================================================
...
export interface EvaluationBenchmarkScoreQueryParams {
...
export interface EvaluationBenchmarkScoreQueryResult<T = unknown> {
  queryId: string;
  records: T[];
  totalCount: number;
...
export class EvaluationBenchmarkScoreQueryPlanner {
  public readonly queryName = 'EvaluationBenchmarkScore';

  public buildSQL(params: EvaluationBenchmarkScoreQueryParams): { sql: string; bindings: unknown[] } {
  ...
  public async execute(params: EvaluationBenchmarkScoreQueryParams): Promise<EvaluationBenchmarkScoreQueryResult> {
...
export const evaluationBenchmarkScoreQueryPlanner = new EvaluationBenchmarkScoreQueryPlanner();
