/**
 * ============================================================================
 * COGNIVANTA QUERY PLANNER: DOCUMENTCHUNKBOUNDING
 * ============================================================================
...
export interface DocumentChunkBoundingQueryParams {
...
export interface DocumentChunkBoundingQueryResult<T = unknown> {
  queryId: string;
  records: T[];
  totalCount: number;
...
export class DocumentChunkBoundingQueryPlanner {
  public readonly queryName = 'DocumentChunkBounding';

  public buildSQL(params: DocumentChunkBoundingQueryParams): { sql: string; bindings: unknown[] } {
  ...
  public async execute(params: DocumentChunkBoundingQueryParams): Promise<DocumentChunkBoundingQueryResult> {
...
export const documentChunkBoundingQueryPlanner = new DocumentChunkBoundingQueryPlanner();
