/**
 * ============================================================================
 * COGNIVANTA QUERY PLANNER: WEBHOOKDELIVERYATTEMPT
 * ============================================================================
...
export interface WebhookDeliveryAttemptQueryParams {
...
export interface WebhookDeliveryAttemptQueryResult<T = unknown> {
  queryId: string;
  records: T[];
  totalCount: number;
...
export class WebhookDeliveryAttemptQueryPlanner {
  public readonly queryName = 'WebhookDeliveryAttempt';

  public buildSQL(params: WebhookDeliveryAttemptQueryParams): { sql: string; bindings: unknown[] } {
  ...
  public async execute(params: WebhookDeliveryAttemptQueryParams): Promise<WebhookDeliveryAttemptQueryResult> {
...
export const webhookDeliveryAttemptQueryPlanner = new WebhookDeliveryAttemptQueryPlanner();
