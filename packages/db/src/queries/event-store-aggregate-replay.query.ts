/**
 * ============================================================================
 * COGNIVANTA QUERY PLANNER: EVENTSTOREAGGREGATEREPLAY
 * ============================================================================
...
export interface EventStoreAggregateReplayQueryParams {
...
export interface EventStoreAggregateReplayQueryResult<T = unknown> {
  queryId: string;
  records: T[];
  totalCount: number;
...
export class EventStoreAggregateReplayQueryPlanner {
  public readonly queryName = 'EventStoreAggregateReplay';

  public buildSQL(params: EventStoreAggregateReplayQueryParams): { sql: string; bindings: unknown[] } {
  ...
  public async execute(params: EventStoreAggregateReplayQueryParams): Promise<EventStoreAggregateReplayQueryResult> {
    ...
    return {
      ...
      records: [
        {
          id: 'eventstoreaggregatereplay-1',
...
export const eventStoreAggregateReplayQueryPlanner = new EventStoreAggregateReplayQueryPlanner();
