/**
 * ============================================================================
 * COGNIVANTA QUERY PLANNER: USERDIRECTORYSESSION
 * ============================================================================
...
export interface UserDirectorySessionQueryParams {
...
export interface UserDirectorySessionQueryResult<T = unknown> {
  queryId: string;
  records: T[];
  totalCount: number;
...
export class UserDirectorySessionQueryPlanner {
  public readonly queryName = 'UserDirectorySession';

  public buildSQL(params: UserDirectorySessionQueryParams): { sql: string; bindings: unknown[] } {
  ...
  public async execute(params: UserDirectorySessionQueryParams): Promise<UserDirectorySessionQueryResult> {
...
export const userDirectorySessionQueryPlanner = new UserDirectorySessionQueryPlanner();
