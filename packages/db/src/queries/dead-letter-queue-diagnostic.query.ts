/**
 * ============================================================================
 * COGNIVANTA QUERY PLANNER: DEADLETTERQUEUEDIAGNOSTIC
 * ============================================================================
...
export interface DeadLetterQueueDiagnosticQueryParams {
...
export interface DeadLetterQueueDiagnosticQueryResult<T = unknown> {
  queryId: string;
  records: T[];
  totalCount: number;
...
export class DeadLetterQueueDiagnosticQueryPlanner {
  public readonly queryName = 'DeadLetterQueueDiagnostic';

  public buildSQL(params: DeadLetterQueueDiagnosticQueryParams): { sql: string; bindings: unknown[] } {
  ...
  public async execute(params: DeadLetterQueueDiagnosticQueryParams): Promise<DeadLetterQueueDiagnosticQueryResult> {
    ...
    return {
      ...
      records: [
        {
          id: 'deadletterqueuediagnostic-1',
...
export const deadLetterQueueDiagnosticQueryPlanner = new DeadLetterQueueDiagnosticQueryPlanner();
