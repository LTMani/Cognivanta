/**
 * ============================================================================
 * COGNIVANTA QUERY PLANNER: DATALINEAGETRACEPATH
 * ============================================================================
...
export interface DataLineageTracePathQueryParams {
...
export interface DataLineageTracePathQueryResult<T = unknown> {
  queryId: string;
  records: T[];
  totalCount: number;
...
export class DataLineageTracePathQueryPlanner {
  public readonly queryName = 'DataLineageTracePath';

  public buildSQL(params: DataLineageTracePathQueryParams): { sql: string; bindings: unknown[] } {
  ...
  public async execute(params: DataLineageTracePathQueryParams): Promise<DataLineageTracePathQueryResult> {
...
export const dataLineageTracePathQueryPlanner = new DataLineageTracePathQueryPlanner();
