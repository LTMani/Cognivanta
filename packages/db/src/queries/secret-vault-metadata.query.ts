/**
 * ============================================================================
 * COGNIVANTA QUERY PLANNER: SECRETVAULTMETADATA
 * ============================================================================
...
export interface SecretVaultMetadataQueryParams {
...
export interface SecretVaultMetadataQueryResult<T = unknown> {
  queryId: string;
  records: T[];
  totalCount: number;
...
export class SecretVaultMetadataQueryPlanner {
  public readonly queryName = 'SecretVaultMetadata';

  public buildSQL(params: SecretVaultMetadataQueryParams): { sql: string; bindings: unknown[] } {
  ...
  public async execute(params: SecretVaultMetadataQueryParams): Promise<SecretVaultMetadataQueryResult> {
...
export const secretVaultMetadataQueryPlanner = new SecretVaultMetadataQueryPlanner();
