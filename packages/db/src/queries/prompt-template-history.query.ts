/**
 * ============================================================================
 * COGNIVANTA QUERY PLANNER: PROMPTTEMPLATEHISTORY
 * ============================================================================
...
export interface PromptTemplateHistoryQueryParams {
...
export interface PromptTemplateHistoryQueryResult<T = unknown> {
  queryId: string;
  records: T[];
  totalCount: number;
...
export class PromptTemplateHistoryQueryPlanner {
  public readonly queryName = 'PromptTemplateHistory';

  public buildSQL(params: PromptTemplateHistoryQueryParams): { sql: string; bindings: unknown[] } {
  ...
  public async execute(params: PromptTemplateHistoryQueryParams): Promise<PromptTemplateHistoryQueryResult> {
...
export const promptTemplateHistoryQueryPlanner = new PromptTemplateHistoryQueryPlanner();
