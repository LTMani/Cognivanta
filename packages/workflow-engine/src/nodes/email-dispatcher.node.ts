/**
 * ============================================================================
 * COGNIVANTA WORKFLOW STEP RUNNER: EMAILDISPATCHERNODERUNNER
 * ============================================================================
 */

import { generateUUID } from '@cognivanta/core';

export class EmailDispatcherNodeRunner {
  public readonly nodeType = 'email-dispatcher';
...
export const email_dispatcherRunner = new EmailDispatcherNodeRunner();
