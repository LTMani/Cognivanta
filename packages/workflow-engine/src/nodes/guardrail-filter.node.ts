/**
 * ============================================================================
 * COGNIVANTA WORKFLOW STEP RUNNER: GUARDRAILFILTERNODERUNNER
 * ============================================================================
 */

import { generateUUID } from '@cognivanta/core';

export class GuardrailFilterNodeRunner {
  public readonly nodeType = 'guardrail-filter';
...
export const guardrail_filterRunner = new GuardrailFilterNodeRunner();
