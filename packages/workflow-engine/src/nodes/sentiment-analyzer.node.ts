/**
 * ============================================================================
 * COGNIVANTA WORKFLOW STEP RUNNER: SENTIMENTANALYZERNODERUNNER
 * ============================================================================
 */

import { generateUUID } from '@cognivanta/core';

export class SentimentAnalyzerNodeRunner {
  public readonly nodeType = 'sentiment-analyzer';
...
export const sentiment_analyzerRunner = new SentimentAnalyzerNodeRunner();
