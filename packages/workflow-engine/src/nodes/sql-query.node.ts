/**
 * ============================================================================
 * COGNIVANTA WORKFLOW STEP RUNNER: SQLQUERYNODERUNNER
 * ============================================================================
 */

import { generateUUID } from '@cognivanta/core';

export class SqlQueryNodeRunner {
  public readonly nodeType = 'sql-query';
...
export const sql_queryRunner = new SqlQueryNodeRunner();
