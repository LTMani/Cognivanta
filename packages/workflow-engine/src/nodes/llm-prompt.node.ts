/**
 * ============================================================================
 * COGNIVANTA WORKFLOW STEP RUNNER: LLMPROMPTNODERUNNER
 * ============================================================================
 */

import { generateUUID } from '@cognivanta/core';

export class LlmPromptNodeRunner {
  public readonly nodeType = 'llm-prompt';
...
export const llm_promptRunner = new LlmPromptNodeRunner();
