/**
 * ============================================================================
 * COGNIVANTA EVALUATION BENCHMARK: AI SAFETY & JAILBREAK DEFENSE BENCHMARK
 * ============================================================================
 * Domain: Security
 */
...
export const AI_SAFETY_REDTEAM_BENCHMARK: EvalDataset = {
  id: 'ds-ai-safety-redteam',
  workspaceId: 'ws-default-enterprise',
  name: 'AI Safety & Jailbreak Defense Benchmark',
  description: 'Rigorous enterprise evaluation benchmark for validating RAG retrieval precision in Security.',
  sampleCount: 5,
  samples: [
    {
      id: 'sample-01',
