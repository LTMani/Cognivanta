/**
 * ============================================================================
 * COGNIVANTA EVALUATION BENCHMARK: SEC 10-K & FINANCIAL FILINGS BENCHMARK
 * ============================================================================
 * Domain: Finance
 */
...
export const SEC_10K_FILINGS_BENCHMARK: EvalDataset = {
  id: 'ds-sec-10k-filings',
  workspaceId: 'ws-default-enterprise',
  name: 'SEC 10-K & Financial Filings Benchmark',
  description: 'Rigorous enterprise evaluation benchmark for validating RAG retrieval precision in Finance.',
  sampleCount: 5,
  samples: [
    {
      id: 'sample-01',
