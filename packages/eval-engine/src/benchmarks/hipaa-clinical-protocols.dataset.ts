/**
 * ============================================================================
 * COGNIVANTA EVALUATION BENCHMARK: HIPAA & CLINICAL PROTOCOLS BENCHMARK
 * ============================================================================
 * Domain: Healthcare
 */
...
export const HIPAA_CLINICAL_PROTOCOLS_BENCHMARK: EvalDataset = {
  id: 'ds-hipaa-clinical-protocols',
  workspaceId: 'ws-default-enterprise',
  name: 'HIPAA & Clinical Protocols Benchmark',
  description: 'Rigorous enterprise evaluation benchmark for validating RAG retrieval precision in Healthcare.',
  sampleCount: 5,
  samples: [
    {
      id: 'sample-01',
