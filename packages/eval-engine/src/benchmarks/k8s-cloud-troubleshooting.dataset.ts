/**
 * ============================================================================
 * COGNIVANTA EVALUATION BENCHMARK: KUBERNETES CLOUD SRE BENCHMARK
 * ============================================================================
 * Domain: DevOps
 */
...
export const K8S_CLOUD_TROUBLESHOOTING_BENCHMARK: EvalDataset = {
  id: 'ds-k8s-cloud-troubleshooting',
  workspaceId: 'ws-default-enterprise',
  name: 'Kubernetes Cloud SRE Benchmark',
  description: 'Rigorous enterprise evaluation benchmark for validating RAG retrieval precision in DevOps.',
  sampleCount: 5,
  samples: [
    {
      id: 'sample-01',
