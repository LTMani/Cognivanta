/**
 * ============================================================================
 * COGNIVANTA EVALUATION BENCHMARK: CUSTOMER SUPPORT ESCALATION BENCHMARK
 * ============================================================================
 * Domain: Support
 */
...
export const CUSTOMER_REFUND_POLICY_BENCHMARK: EvalDataset = {
  id: 'ds-customer-refund-policy',
  workspaceId: 'ws-default-enterprise',
  name: 'Customer Support Escalation Benchmark',
  description: 'Rigorous enterprise evaluation benchmark for validating RAG retrieval precision in Support.',
  sampleCount: 5,
  samples: [
    {
      id: 'sample-01',
