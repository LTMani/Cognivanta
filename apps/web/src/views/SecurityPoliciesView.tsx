  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold text-slate-100">Security & Access Control Policies</h1>
          <p className="text-sm text-slate-400 mt-1">
            Manage ABAC dynamic policies, IP whitelisting, SSO SAML settings, and data retention rules.
          </p>
        </div>
