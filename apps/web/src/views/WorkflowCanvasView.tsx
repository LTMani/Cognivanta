  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold text-slate-100">Visual DAG Workflow Canvas</h1>
          <p className="text-sm text-slate-400 mt-1">
            Interactive visual workflow builder with drag-and-drop trigger, LLM, RAG, and condition nodes.
          </p>
        </div>
