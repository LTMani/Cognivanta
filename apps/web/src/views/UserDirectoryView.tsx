  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold text-slate-100">Enterprise User Directory</h1>
          <p className="text-sm text-slate-400 mt-1">
            Manage user profiles, MFA status, authentication sessions, and security clearance levels.
          </p>
        </div>
