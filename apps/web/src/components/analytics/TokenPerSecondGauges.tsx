...
interface TokenPerSecondGaugesProps {
  ...
  return (
    <Card className="flex flex-col">
      <div className="flex items-center justify-between border-b border-slate-800 pb-3 mb-4">
        <div>
          <h3 className="text-sm font-semibold text-slate-100">Generation Speed & Tokens/Sec</h3>
          <p className="text-xs text-slate-400 mt-0.5">Real-time streaming throughput metrics for active LLM completions.</p>
        </div>
      ...
      >
        <div>
          ...
          <p className="text-sm font-medium text-slate-200">Generation Speed & Tokens/Sec</p>
