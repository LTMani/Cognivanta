...
interface ErrorRateTimeseriesProps {
  ...
  return (
    <Card className="flex flex-col">
      <div className="flex items-center justify-between border-b border-slate-800 pb-3 mb-4">
        <div>
          <h3 className="text-sm font-semibold text-slate-100">Provider Status & Error Rates</h3>
          <p className="text-xs text-slate-400 mt-0.5">Timeseries tracking 4xx/5xx HTTP error spikes and circuit breaker trips.</p>
        </div>
      ...
      >
        <div>
          ...
          <p className="text-sm font-medium text-slate-200">Provider Status & Error Rates</p>
