...
interface CostByModelBarChartProps {
  ...
  return (
    <Card className="flex flex-col">
      <div className="flex items-center justify-between border-b border-slate-800 pb-3 mb-4">
        <div>
          <h3 className="text-sm font-semibold text-slate-100">Token Cost Breakdown by LLM Model</h3>
          <p className="text-xs text-slate-400 mt-0.5">Multi-provider cost attribution comparing GPT-4o, Claude 3.5 Sonnet, and Gemini 1.5 Pro.</p>
        </div>
      ...
      >
        <div>
          ...
          <p className="text-sm font-medium text-slate-200">Token Cost Breakdown by LLM Model</p>
