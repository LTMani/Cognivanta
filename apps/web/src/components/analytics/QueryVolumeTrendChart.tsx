...
interface QueryVolumeTrendChartProps {
  ...
  return (
    <Card className="flex flex-col">
      <div className="flex items-center justify-between border-b border-slate-800 pb-3 mb-4">
        <div>
          <h3 className="text-sm font-semibold text-slate-100">Query Volume & Throughput Trend</h3>
          <p className="text-xs text-slate-400 mt-0.5">Hourly and daily AI query volume over time with moving average overlay.</p>
        </div>
      ...
      >
        <div>
          ...
          <p className="text-sm font-medium text-slate-200">Query Volume & Throughput Trend</p>
