...
interface UserActivityLeaderboardProps {
  ...
  return (
    <Card className="flex flex-col">
      <div className="flex items-center justify-between border-b border-slate-800 pb-3 mb-4">
        <div>
          <h3 className="text-sm font-semibold text-slate-100">Top Users by Query Consumption</h3>
          <p className="text-xs text-slate-400 mt-0.5">Leaderboard of top enterprise departments and users by token spend.</p>
        </div>
      ...
      >
        <div>
          ...
          <p className="text-sm font-medium text-slate-200">Top Users by Query Consumption</p>
