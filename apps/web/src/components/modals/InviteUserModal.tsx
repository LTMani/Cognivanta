...
export const InviteUserModal: React.FC<undefined> = ({ isOpen, onClose, onSubmit }) => {
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} title="Invite Enterprise Member">
      <form onSubmit={handleSubmit} className="space-y-4">
        <p className="text-sm text-slate-400">
          Modal for assigning organization roles (Admin, Editor, Viewer, Data Steward).
        </p>
