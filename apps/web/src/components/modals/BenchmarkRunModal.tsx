...
export const BenchmarkRunModal: React.FC<undefined> = ({ isOpen, onClose, onSubmit }) => {
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} title="Execute Evaluation Benchmark">
      <form onSubmit={handleSubmit} className="space-y-4">
        <p className="text-sm text-slate-400">
          Modal for running golden evaluation datasets against target LLM models.
        </p>
