...
export const LLMJudgeModal: React.FC<undefined> = ({ isOpen, onClose, onSubmit }) => {
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} title="Configure LLM-as-a-Judge">
      <form onSubmit={handleSubmit} className="space-y-4">
        <p className="text-sm text-slate-400">
          Modal for defining evaluation rubrics, faithfulness thresholds, and judge models.
        </p>
