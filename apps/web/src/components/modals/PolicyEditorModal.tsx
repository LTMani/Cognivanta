...
export const PolicyEditorModal: React.FC<undefined> = ({ isOpen, onClose, onSubmit }) => {
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} title="Edit ABAC Security Policy">
      <form onSubmit={handleSubmit} className="space-y-4">
        <p className="text-sm text-slate-400">
          Modal for authoring dynamic attribute-based access control rules.
        </p>
