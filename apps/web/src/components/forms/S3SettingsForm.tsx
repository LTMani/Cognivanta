...
export const S3SettingsForm: React.FC<undefined> = ({ initialValues = {}, onSave, onCancel }) => {
  ...
  return (
    <Card className="p-6">
      <div className="border-b border-slate-800 pb-4 mb-6">
        <h2 className="text-lg font-bold text-slate-100">Amazon S3 Bucket Settings</h2>
        <p className="text-xs text-slate-400 mt-1">Form for AWS S3 credentials, bucket names, and IAM role ARNs.</p>
      </div>
