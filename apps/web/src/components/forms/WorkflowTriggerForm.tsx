...
export const WorkflowTriggerForm: React.FC<undefined> = ({ initialValues = {}, onSave, onCancel }) => {
  ...
  return (
    <Card className="p-6">
      <div className="border-b border-slate-800 pb-4 mb-6">
        <h2 className="text-lg font-bold text-slate-100">Workflow Trigger Configuration</h2>
        <p className="text-xs text-slate-400 mt-1">Form for cron schedule expressions, webhook secrets, and Kafka topics.</p>
      </div>
