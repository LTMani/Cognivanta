...
export const AuditExportForm: React.FC<undefined> = ({ initialValues = {}, onSave, onCancel }) => {
  ...
  return (
    <Card className="p-6">
      <div className="border-b border-slate-800 pb-4 mb-6">
        <h2 className="text-lg font-bold text-slate-100">Audit Trail Export Options</h2>
        <p className="text-xs text-slate-400 mt-1">Form for selecting date ranges, actor filters, and SHA-256 verification.</p>
      </div>
