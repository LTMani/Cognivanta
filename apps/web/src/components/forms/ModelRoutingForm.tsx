...
interface ModelRoutingFormProps {
  ...
  return (
    <Card className="p-6">
      <div className="border-b border-slate-800 pb-4 mb-6">
        <h2 className="text-lg font-bold text-slate-100">Model Gateway Routing Policies</h2>
        <p className="text-xs text-slate-400 mt-1">Form to set fallback cascades, latency thresholds, and cost budgets.</p>
      </div>
