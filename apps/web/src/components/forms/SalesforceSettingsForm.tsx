...
interface SalesforceSettingsFormProps {
  initialValues?: Record<string, unknown>;
  onSave?: (values: Record<string, unknown>) => void;
  onCancel?: () => void;
}

export const SalesforceSettingsForm: React.FC<undefined> = ({ initialValues = {}, onSave, onCancel }) => {
  ...
  return (
    <Card className="p-6">
      <div className="border-b border-slate-800 pb-4 mb-6">
        <h2 className="text-lg font-bold text-slate-100">Salesforce CRM Integration</h2>
        <p className="text-xs text-slate-400 mt-1">Form for Salesforce Connected App credentials and SOQL filters.</p>
      </div>
