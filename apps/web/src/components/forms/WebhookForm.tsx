...
export const WebhookForm: React.FC<undefined> = ({ initialValues = {}, onSave, onCancel }) => {
  ...
  return (
    <Card className="p-6">
      <div className="border-b border-slate-800 pb-4 mb-6">
        <h2 className="text-lg font-bold text-slate-100">Event Webhook Subscription</h2>
        <p className="text-xs text-slate-400 mt-1">Form for endpoint URLs, HMAC signing keys, and subscribed events.</p>
      </div>
