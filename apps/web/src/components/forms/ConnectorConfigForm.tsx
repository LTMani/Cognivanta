...
export const ConnectorConfigForm: React.FC<undefined> = ({ initialValues = {}, onSave, onCancel }) => {
  ...
  return (
    <Card className="p-6">
      <div className="border-b border-slate-800 pb-4 mb-6">
        <h2 className="text-lg font-bold text-slate-100">Configure Data Connector</h2>
        <p className="text-xs text-slate-400 mt-1">Form to set up SaaS integrations with continuous synchronization.</p>
      </div>
