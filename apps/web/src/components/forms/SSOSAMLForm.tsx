...
export const SSOSAMLForm: React.FC<undefined> = ({ initialValues = {}, onSave, onCancel }) => {
  ...
  return (
    <Card className="p-6">
      <div className="border-b border-slate-800 pb-4 mb-6">
        <h2 className="text-lg font-bold text-slate-100">SAML 2.0 Single Sign-On</h2>
        <p className="text-xs text-slate-400 mt-1">Form for IdP metadata XML, Entity ID, and Single Sign-On ACS URLs.</p>
      </div>
