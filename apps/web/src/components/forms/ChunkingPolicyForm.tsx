...
interface ChunkingPolicyFormProps {
  initialValues?: Record<string, unknown>;
  onSave?: (values: Record<string, unknown>) => void;
  onCancel?: () => void;
}

export const ChunkingPolicyForm: React.FC<undefined> = ({ initialValues = {}, onSave, onCancel }) => {
  ...
  return (
    <Card className="p-6">
      <div className="border-b border-slate-800 pb-4 mb-6">
        <h2 className="text-lg font-bold text-slate-100">Document Chunking Policy</h2>
        <p className="text-xs text-slate-400 mt-1">Form for chunk size in tokens, overlap percentage, and separator regex.</p>
      </div>
