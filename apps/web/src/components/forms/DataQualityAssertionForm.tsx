...
interface DataQualityAssertionFormProps {
  initialValues?: Record<string, unknown>;
  onSave?: (values: Record<string, unknown>) => void;
  onCancel?: () => void;
}

export const DataQualityAssertionForm: React.FC<undefined> = ({ initialValues = {}, onSave, onCancel }) => {
  ...
  return (
    <Card className="p-6">
      <div className="border-b border-slate-800 pb-4 mb-6">
        <h2 className="text-lg font-bold text-slate-100">Data Quality & Schema Rules</h2>
        <p className="text-xs text-slate-400 mt-1">Form for setting schema assertions and anomaly alert thresholds.</p>
      </div>
