...
interface AuditChainVisualizerProps {
  title?: string;
  data?: unknown;
  height?: number;
}
    ...
    <Card className="flex flex-col">
      ...
      >
        <div>
          ...
          <p className="text-sm font-medium text-slate-200">Cryptographic block chain visualizer illustrating SHA-256 link integrity.</p>
