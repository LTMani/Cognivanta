...
interface TokenSunburstChartProps {
  title?: string;
  data?: unknown;
  height?: number;
}
    ...
    <Card className="flex flex-col">
      ...
      >
        <div>
          ...
          <p className="text-sm font-medium text-slate-200">Interactive hierarchical sunburst visualization of token usage by department and model.</p>
