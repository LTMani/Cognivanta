...
interface CostHeatmapWidgetProps {
  title?: string;
  data?: unknown;
  height?: number;
}
    ...
    <Card className="flex flex-col">
      ...
      >
        <div>
          ...
          <p className="text-sm font-medium text-slate-200">Weekly calendar heatmap highlighting hourly token consumption spikes and anomalies.</p>
