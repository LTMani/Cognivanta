...
export const MultiAgentDebatePage: React.FC = () => {
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold text-slate-100">Multi-Agent Adversarial Debate Arena</h1>
          <p className="text-sm text-slate-400 mt-1">
            Orchestrate structured debates between proponent and opponent agents with automated arbiter verdicts.
          </p>
        </div>
