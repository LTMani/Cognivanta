/**
 * ============================================================================
 * COGNIVANTA DOMAIN SERVICE: WEBHOOKSUBSCRIPTIONSERVICE
 * ============================================================================
 * Encapsulates business logic, authorization verification, database operations,
 * audit event dispatching, and error handling for WebhookSubscription.
 */
...
export class WebhookSubscriptionService {
  ...
  public async create(dto: WebhookSubscriptionDTO, userId: string): Promise<Record<string, unknown>> {
    const id = dto.id || generateUUID();
    const record = {
      id,
      name: dto.name || 'WebhookSubscription Record',
  ...
  public async update(id: string, updates: Partial<WebhookSubscriptionDTO>, userId: string): Promise<Record<string, unknown> | null> {
